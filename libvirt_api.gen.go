// Code generated by cmd/libvirt-api-gen; DO NOT EDIT.
// Combined libvirt API XML SHA-256: e97296404c4ce242da6d974ff4da7bf9b9f75e18cc2660efe626181728e0ea76.

package libvirt

import "unsafe"

const generatedLibvirtAPIHash = "e97296404c4ce242da6d974ff4da7bf9b9f75e18cc2660efe626181728e0ea76"
...
type generatedNativeAPI struct {
	...
	virDomainAnnounceInterface                 func(unsafe.Pointer, *byte, unsafe.Pointer, int32, uint32) int32
...
func libvirtSymbolBindings(api *nativeAPI) []nativeSymbolBinding {
	return []nativeSymbolBinding{
		...
		{name: "virDomainAnnounceInterface", since: "12.5.0", library: "main", target: &api.virDomainAnnounceInterface},
...
var generatedLibvirtSymbolVersions = map[string]string{
	...
	"virDomainAnnounceInterface":                 "12.5.0",
...
func (raw *RawAPI) VirDomainAnnounceInterface(dom unsafe.Pointer, device *byte, params unsafe.Pointer, nparams int32, flags uint32) (int32, error) {
	if err := raw.requireSymbol("virDomainAnnounceInterface"); err != nil {
		var zero int32
		return zero, err
	}
	return raw.api.virDomainAnnounceInterface(dom, device, params, nparams, flags), nil
}
...
// Official constants drop libvirt's C-only VIR_ prefix, matching libvirt-go-module.
const (
	CLIENT_TRANS_LAST                                                                       = VIR_CLIENT_TRANS_LAST
	CLIENT_TRANS_TCP                                                                        = VIR_CLIENT_TRANS_TCP
	CLIENT_TRANS_TLS                                                                        = VIR_CLIENT_TRANS_TLS
	CLIENT_TRANS_UNIX                                                                       = VIR_CLIENT_TRANS_UNIX
	CONNECT_BASELINE_CPU_EXPAND_FEATURES                                                    = VIR_CONNECT_BASELINE_CPU_EXPAND_FEATURES
	CONNECT_BASELINE_CPU_IGNORE_HOST                                                        = VIR_CONNECT_BASELINE_CPU_IGNORE_HOST
	CONNECT_BASELINE_CPU_MIGRATABLE                                                         = VIR_CONNECT_BASELINE_CPU_MIGRATABLE
	CONNECT_CLOSE_REASON_CLIENT                                                             = VIR_CONNECT_CLOSE_REASON_CLIENT
	CONNECT_CLOSE_REASON_EOF                                                                = VIR_CONNECT_CLOSE_REASON_EOF
	CONNECT_CLOSE_REASON_ERROR                                                              = VIR_CONNECT_CLOSE_REASON_ERROR
	CONNECT_CLOSE_REASON_KEEPALIVE                                                          = VIR_CONNECT_CLOSE_REASON_KEEPALIVE
	CONNECT_CLOSE_REASON_LAST                                                               = VIR_CONNECT_CLOSE_REASON_LAST
	CONNECT_COMPARE_CPU_FAIL_INCOMPATIBLE                                                   = VIR_CONNECT_COMPARE_CPU_FAIL_INCOMPATIBLE
	CONNECT_COMPARE_CPU_VALIDATE_XML                                                        = VIR_CONNECT_COMPARE_CPU_VALIDATE_XML
	CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_REASON_CHANNEL                                     = VIR_CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_REASON_CHANNEL
	CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_REASON_DOMAIN_STARTED                              = VIR_CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_REASON_DOMAIN_STARTED
	CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_REASON_LAST                                        = VIR_CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_REASON_LAST
	CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_REASON_UNKNOWN                                     = VIR_CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_REASON_UNKNOWN
	CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_STATE_CONNECTED                                    = VIR_CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_STATE_CONNECTED
	CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_STATE_DISCONNECTED                                 = VIR_CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_STATE_DISCONNECTED
	CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_STATE_LAST                                         = VIR_CONNECT_DOMAIN_EVENT_AGENT_LIFECYCLE_STATE_LAST
	CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_CHANNEL                                   = VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_CHANNEL
	CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_DOMAIN_STARTED                            = VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_DOMAIN_STARTED
	CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_LAST                                      = VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_LAST
	CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_UNKNOWN                                   = VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_REASON_UNKNOWN
	CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_CONNECTED                                  = VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_CONNECTED
	CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_DISCONNECTED                               = VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_DISCONNECTED
	CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_LAST                                       = VIR_CONNECT_DOMAIN_EVENT_CHANNEL_LIFECYCLE_STATE_LAST
	CONNECT_DOMAIN_QEMU_MONITOR_EVENT_REGISTER_NOCASE                                       = VIR_CONNECT_DOMAIN_QEMU_MONITOR_EVENT_REGISTER_NOCASE
	CONNECT_DOMAIN_QEMU_MONITOR_EVENT_REGISTER_REGEX                                        = VIR_CONNECT_DOMAIN_QEMU_MONITOR_EVENT_REGISTER_REGEX
	CONNECT_GET_ALL_DOMAINS_STATS_ACTIVE                                                    = VIR_CONNECT_GET_ALL_DOMAINS_STATS_ACTIVE
	CONNECT_GET_ALL_DOMAINS_STATS_BACKING                                                   = VIR_CONNECT_GET_ALL_DOMAINS_STATS_BACKING
	CONNECT_GET_ALL_DOMAINS_STATS_ENFORCE_STATS                                             = VIR_CONNECT_GET_ALL_DOMAINS_STATS_ENFORCE_STATS
	CONNECT_GET_ALL_DOMAINS_STATS_INACTIVE                                                  = VIR_CONNECT_GET_ALL_DOMAINS_STATS_INACTIVE
	CONNECT_GET_ALL_DOMAINS_STATS_NOWAIT                                                    = VIR_CONNECT_GET_ALL_DOMAINS_STATS_NOWAIT
	CONNECT_GET_ALL_DOMAINS_STATS_OTHER                                                     = VIR_CONNECT_GET_ALL_DOMAINS_STATS_OTHER
	CONNECT_GET_ALL_DOMAINS_STATS_PAUSED                                                    = VIR_CONNECT_GET_ALL_DOMAINS_STATS_PAUSED
	CONNECT_GET_ALL_DOMAINS_STATS_PERSISTENT                                                = VIR_CONNECT_GET_ALL_DOMAINS_STATS_PERSISTENT
	CONNECT_GET_ALL_DOMAINS_STATS_RUNNING                                                   = VIR_CONNECT_GET_ALL_DOMAINS_STATS_RUNNING
	CONNECT_GET_ALL_DOMAINS_STATS_SHUTOFF                                                   = VIR_CONNECT_GET_ALL_DOMAINS_STATS_SHUTOFF
	CONNECT_GET_ALL_DOMAINS_STATS_TRANSIENT                                                 = VIR_CONNECT_GET_ALL_DOMAINS_STATS_TRANSIENT
	CONNECT_GET_DOMAIN_CAPABILITIES_DISABLE_DEPRECATED_FEATURES                             = VIR_CONNECT_GET_DOMAIN_CAPABILITIES_DISABLE_DEPRECATED_FEATURES
	CONNECT_GET_DOMAIN_CAPABILITIES_EXPAND_CPU_FEATURES                                     = VIR_CONNECT_GET_DOMAIN_CAPABILITIES_EXPAND_CPU_FEATURES
	CONNECT_GET_DOMAIN_CAPABILITIES_SUPPORTED_CPU_FEATURES                                  = VIR_CONNECT_GET_DOMAIN_CAPABILITIES_SUPPORTED_CPU_FEATURES
	CONNECT_LIST_DOMAINS_ACTIVE                                  ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_ACTIVE)
	CONNECT_LIST_DOMAINS_AUTOSTART                               ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_AUTOSTART)
	CONNECT_LIST_DOMAINS_HAS_CHECKPOINT                          ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_HAS_CHECKPOINT)
	CONNECT_LIST_DOMAINS_HAS_SNAPSHOT                            ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_HAS_SNAPSHOT)
	CONNECT_LIST_DOMAINS_INACTIVE                                ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_INACTIVE)
	CONNECT_LIST_DOMAINS_MANAGEDSAVE                             ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_MANAGEDSAVE)
	CONNECT_LIST_DOMAINS_NO_AUTOSTART                            ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_NO_AUTOSTART)
	CONNECT_LIST_DOMAINS_NO_CHECKPOINT                           ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_NO_CHECKPOINT)
	CONNECT_LIST_DOMAINS_NO_MANAGEDSAVE                          ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_NO_MANAGEDSAVE)
	CONNECT_LIST_DOMAINS_NO_SNAPSHOT                             ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_NO_SNAPSHOT)
	CONNECT_LIST_DOMAINS_OTHER                                   ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_OTHER)
	CONNECT_LIST_DOMAINS_PAUSED                                  ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_PAUSED)
	CONNECT_LIST_DOMAINS_PERSISTENT                              ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_PERSISTENT)
	CONNECT_LIST_DOMAINS_RUNNING                                 ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_RUNNING)
	CONNECT_LIST_DOMAINS_SHUTOFF                                 ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_SHUTOFF)
	CONNECT_LIST_DOMAINS_TRANSIENT                               ConnectListAllDomainsFlags = ConnectListAllDomainsFlags(VIR_CONNECT_LIST_DOMAINS_TRANSIENT)
	CONNECT_LIST_INTERFACES_ACTIVE                                                          = VIR_CONNECT_LIST_INTERFACES_ACTIVE
	CONNECT_LIST_INTERFACES_INACTIVE                                                        = VIR_CONNECT_LIST_INTERFACES_INACTIVE
	CONNECT_LIST_NETWORKS_ACTIVE                                                            = VIR_CONNECT_LIST_NETWORKS_ACTIVE
	CONNECT_LIST_NETWORKS_AUTOSTART                                                         = VIR_CONNECT_LIST_NETWORKS_AUTOSTART
	CONNECT_LIST_NETWORKS_INACTIVE                                                          = VIR_CONNECT_LIST_NETWORKS_INACTIVE
	CONNECT_LIST_NETWORKS_NO_AUTOSTART                                                      = VIR_CONNECT_LIST_NETWORKS_NO_AUTOSTART
	CONNECT_LIST_NETWORKS_PERSISTENT                                                        = VIR_CONNECT_LIST_NETWORKS_PERSISTENT
	CONNECT_LIST_NETWORKS_TRANSIENT                                                         = VIR_CONNECT_LIST_NETWORKS_TRANSIENT
	CONNECT_LIST_NODE_DEVICES_ACTIVE                                                        = VIR_CONNECT_LIST_NODE_DEVICES_ACTIVE
	CONNECT_LIST_NODE_DEVICES_CAP_AP_CARD                                                   = VIR_CONNECT_LIST_NODE_DEVICES_CAP_AP_CARD
	CONNECT_LIST_NODE_DEVICES_CAP_AP_MATRIX                                                 = VIR_CONNECT_LIST_NODE_DEVICES_CAP_AP_MATRIX
	CONNECT_LIST_NODE_DEVICES_CAP_AP_QUEUE                                                  = VIR_CONNECT_LIST_NODE_DEVICES_CAP_AP_QUEUE
	CONNECT_LIST_NODE_DEVICES_CAP_CCWGROUP_DEV                                              = VIR_CONNECT_LIST_NODE_DEVICES_CAP_CCWGROUP_DEV
	CONNECT_LIST_NODE_DEVICES_CAP_CCWGROUP_MEMBER                                           = VIR_CONNECT_LIST_NODE_DEVICES_CAP_CCWGROUP_MEMBER
	CONNECT_LIST_NODE_DEVICES_CAP_CCW_DEV                                                   = VIR_CONNECT_LIST_NODE_DEVICES_CAP_CCW_DEV
	CONNECT_LIST_NODE_DEVICES_CAP_CSS_DEV                                                   = VIR_CONNECT_LIST_NODE_DEVICES_CAP_CSS_DEV
	CONNECT_LIST_NODE_DEVICES_CAP_DRM                                                       = VIR_CONNECT_LIST_NODE_DEVICES_CAP_DRM
	CONNECT_LIST_NODE_DEVICES_CAP_FC_HOST                                                   = VIR_CONNECT_LIST_NODE_DEVICES_CAP_FC_HOST
	CONNECT_LIST_NODE_DEVICES_CAP_MDEV                                                      = VIR_CONNECT_LIST_NODE_DEVICES_CAP_MDEV
	CONNECT_LIST_NODE_DEVICES_CAP_MDEV_TYPES                                                = VIR_CONNECT_LIST_NODE_DEVICES_CAP_MDEV_TYPES
	CONNECT_LIST_NODE_DEVICES_CAP_NET                                                       = VIR_CONNECT_LIST_NODE_DEVICES_CAP_NET
	CONNECT_LIST_NODE_DEVICES_CAP_PCI_DEV                                                   = VIR_CONNECT_LIST_NODE_DEVICES_CAP_PCI_DEV
	CONNECT_LIST_NODE_DEVICES_CAP_SCSI                                                      = VIR_CONNECT_LIST_NODE_DEVICES_CAP_SCSI
	CONNECT_LIST_NODE_DEVICES_CAP_SCSI_GENERIC                                              = VIR_CONNECT_LIST_NODE_DEVICES_CAP_SCSI_GENERIC
	CONNECT_LIST_NODE_DEVICES_CAP_SCSI_HOST                                                 = VIR_CONNECT_LIST_NODE_DEVICES_CAP_SCSI_HOST
	CONNECT_LIST_NODE_DEVICES_CAP_SCSI_TARGET                                               = VIR_CONNECT_LIST_NODE_DEVICES_CAP_SCSI_TARGET
	CONNECT_LIST_NODE_DEVICES_CAP_STORAGE                                                   = VIR_CONNECT_LIST_NODE_DEVICES_CAP_STORAGE
	CONNECT_LIST_NODE_DEVICES_CAP_SYSTEM                                                    = VIR_CONNECT_LIST_NODE_DEVICES_CAP_SYSTEM
	CONNECT_LIST_NODE_DEVICES_CAP_USB_DEV                                                   = VIR_CONNECT_LIST_NODE_DEVICES_CAP_USB_DEV
	CONNECT_LIST_NODE_DEVICES_CAP_USB_INTERFACE                                             = VIR_CONNECT_LIST_NODE_DEVICES_CAP_USB_INTERFACE
	CONNECT_LIST_NODE_DEVICES_CAP_VDPA                                                      = VIR_CONNECT_LIST_NODE_DEVICES_CAP_VDPA
	CONNECT_LIST_NODE_DEVICES_CAP_VPD                                                       = VIR_CONNECT_LIST_NODE_DEVICES_CAP_VPD
	CONNECT_LIST_NODE_DEVICES_CAP_VPORTS                                                    = VIR_CONNECT_LIST_NODE_DEVICES_CAP_VPORTS
	CONNECT_LIST_NODE_DEVICES_INACTIVE                                                      = VIR_CONNECT_LIST_NODE_DEVICES_INACTIVE
	CONNECT_LIST_NODE_DEVICES_PERSISTENT                                                    = VIR_CONNECT_LIST_NODE_DEVICES_PERSISTENT
	CONNECT_LIST_NODE_DEVICES_TRANSIENT                                                     = VIR_CONNECT_LIST_NODE_DEVICES_TRANSIENT
	CONNECT_LIST_SECRETS_EPHEMERAL                                                          = VIR_CONNECT_LIST_SECRETS_EPHEMERAL
	CONNECT_LIST_SECRETS_NO_EPHEMERAL                                                       = VIR_CONNECT_LIST_SECRETS_NO_EPHEMERAL
	CONNECT_LIST_SECRETS_NO_PRIVATE                                                         = VIR_CONNECT_LIST_SECRETS_NO_PRIVATE
	CONNECT_LIST_SECRETS_PRIVATE                                                            = VIR_CONNECT_LIST_SECRETS_PRIVATE
	CONNECT_LIST_STORAGE_POOLS_ACTIVE                                                       = VIR_CONNECT_LIST_STORAGE_POOLS_ACTIVE
	CONNECT_LIST_STORAGE_POOLS_AUTOSTART                                                    = VIR_CONNECT_LIST_STORAGE_POOLS_AUTOSTART
	CONNECT_LIST_STORAGE_POOLS_DIR                                                          = VIR_CONNECT_LIST_STORAGE_POOLS_DIR
	CONNECT_LIST_STORAGE_POOLS_DISK                                                         = VIR_CONNECT_LIST_STORAGE_POOLS_DISK
	CONNECT_LIST_STORAGE_POOLS_FS                                                           = VIR_CONNECT_LIST_STORAGE_POOLS_FS
	CONNECT_LIST_STORAGE_POOLS_GLUSTER                                                      = VIR_CONNECT_LIST_STORAGE_POOLS_GLUSTER
	CONNECT_LIST_STORAGE_POOLS_INACTIVE                                                     = VIR_CONNECT_LIST_STORAGE_POOLS_INACTIVE
	CONNECT_LIST_STORAGE_POOLS_ISCSI                                                        = VIR_CONNECT_LIST_STORAGE_POOLS_ISCSI
	CONNECT_LIST_STORAGE_POOLS_ISCSI_DIRECT                                                 = VIR_CONNECT_LIST_STORAGE_POOLS_ISCSI_DIRECT
	CONNECT_LIST_STORAGE_POOLS_LOGICAL                                                      = VIR_CONNECT_LIST_STORAGE_POOLS_LOGICAL
	CONNECT_LIST_STORAGE_POOLS_MPATH                                                        = VIR_CONNECT_LIST_STORAGE_POOLS_MPATH
	CONNECT_LIST_STORAGE_POOLS_NETFS                                                        = VIR_CONNECT_LIST_STORAGE_POOLS_NETFS
	CONNECT_LIST_STORAGE_POOLS_NO_AUTOSTART                                                 = VIR_CONNECT_LIST_STORAGE_POOLS_NO_AUTOSTART
	CONNECT_LIST_STORAGE_POOLS_PERSISTENT                                                   = VIR_CONNECT_LIST_STORAGE_POOLS_PERSISTENT
	CONNECT_LIST_STORAGE_POOLS_RBD                                                          = VIR_CONNECT_LIST_STORAGE_POOLS_RBD
	CONNECT_LIST_STORAGE_POOLS_SCSI                                                         = VIR_CONNECT_LIST_STORAGE_POOLS_SCSI
	CONNECT_LIST_STORAGE_POOLS_SHEEPDOG                                                     = VIR_CONNECT_LIST_STORAGE_POOLS_SHEEPDOG
	CONNECT_LIST_STORAGE_POOLS_TRANSIENT                                                    = VIR_CONNECT_LIST_STORAGE_POOLS_TRANSIENT
	CONNECT_LIST_STORAGE_POOLS_VSTORAGE                                                     = VIR_CONNECT_LIST_STORAGE_POOLS_VSTORAGE
	CONNECT_LIST_STORAGE_POOLS_ZFS                                                          = VIR_CONNECT_LIST_STORAGE_POOLS_ZFS
	CONNECT_NO_ALIASES                                                                      = VIR_CONNECT_NO_ALIASES
	CONNECT_RO                                                                              = VIR_CONNECT_RO
	CPU_COMPARE_ERROR                                                                       = VIR_CPU_COMPARE_ERROR
	CPU_COMPARE_IDENTICAL                                                                   = VIR_CPU_COMPARE_IDENTICAL
	CPU_COMPARE_INCOMPATIBLE                                                                = VIR_CPU_COMPARE_INCOMPATIBLE
	CPU_COMPARE_LAST                                                                        = VIR_CPU_COMPARE_LAST
	CPU_COMPARE_SUPERSET                                                                    = VIR_CPU_COMPARE_SUPERSET
	CRED_AUTHNAME                                                                           = VIR_CRED_AUTHNAME
	CRED_CNONCE                                                                             = VIR_CRED_CNONCE
	CRED_ECHOPROMPT                                                                         = VIR_CRED_ECHOPROMPT
	CRED_EXTERNAL                                                                           = VIR_CRED_EXTERNAL
	CRED_LANGUAGE                                                                           = VIR_CRED_LANGUAGE
	CRED_LAST                                                                               = VIR_CRED_LAST
	CRED_NOECHOPROMPT                                                                       = VIR_CRED_NOECHOPROMPT
	CRED_PASSPHRASE                                                                         = VIR_CRED_PASSPHRASE
	CRED_REALM                                                                              = VIR_CRED_REALM
	CRED_USERNAME                                                                           = VIR_CRED_USERNAME
	DAEMON_SHUTDOWN_PRESERVE                                                                = VIR_DAEMON_SHUTDOWN_PRESERVE
	DOMAIN_ABORT_JOB_POSTCOPY                                                               = VIR_DOMAIN_ABORT_JOB_POSTCOPY
	DOMAIN_AFFECT_CONFIG                                                                    = VIR_DOMAIN_AFFECT_CONFIG
	DOMAIN_AFFECT_CURRENT                                                                   = VIR_DOMAIN_AFFECT_CURRENT
	DOMAIN_AFFECT_LIVE                                                                      = VIR_DOMAIN_AFFECT_LIVE
	DOMAIN_AGENT_RESPONSE_TIMEOUT_BLOCK                                                     = VIR_DOMAIN_AGENT_RESPONSE_TIMEOUT_BLOCK
	DOMAIN_AGENT_RESPONSE_TIMEOUT_DEFAULT                                                   = VIR_DOMAIN_AGENT_RESPONSE_TIMEOUT_DEFAULT
	DOMAIN_AGENT_RESPONSE_TIMEOUT_NOWAIT                                                    = VIR_DOMAIN_AGENT_RESPONSE_TIMEOUT_NOWAIT
	DOMAIN_AUTHORIZED_SSH_KEYS_SET_APPEND                                                   = VIR_DOMAIN_AUTHORIZED_SSH_KEYS_SET_APPEND
	DOMAIN_AUTHORIZED_SSH_KEYS_SET_REMOVE                                                   = VIR_DOMAIN_AUTHORIZED_SSH_KEYS_SET_REMOVE
	DOMAIN_BACKUP_BEGIN_PRESERVE_SHUTDOWN_DOMAIN                                            = VIR_DOMAIN_BACKUP_BEGIN_PRESERVE_SHUTDOWN_DOMAIN
	DOMAIN_BACKUP_BEGIN_REUSE_EXTERNAL                                                      = VIR_DOMAIN_BACKUP_BEGIN_REUSE_EXTERNAL
	DOMAIN_BLKIO_PARAM_BOOLEAN                                                              = VIR_DOMAIN_BLKIO_PARAM_BOOLEAN
	DOMAIN_BLKIO_PARAM_DOUBLE                                                               = VIR_DOMAIN_BLKIO_PARAM_DOUBLE
	DOMAIN_BLKIO_PARAM_INT                                                                  = VIR_DOMAIN_BLKIO_PARAM_INT
	DOMAIN_BLKIO_PARAM_LLONG                                                                = VIR_DOMAIN_BLKIO_PARAM_LLONG
	DOMAIN_BLKIO_PARAM_UINT                                                                 = VIR_DOMAIN_BLKIO_PARAM_UINT
	DOMAIN_BLKIO_PARAM_ULLONG                                                               = VIR_DOMAIN_BLKIO_PARAM_ULLONG
	DOMAIN_BLOCKED                                               DomainState                = DomainState(VIR_DOMAIN_BLOCKED)
	DOMAIN_BLOCKED_LAST                                                                     = VIR_DOMAIN_BLOCKED_LAST
	DOMAIN_BLOCKED_UNKNOWN                                                                  = VIR_DOMAIN_BLOCKED_UNKNOWN
	DOMAIN_BLOCK_COMMIT_ACTIVE                                                              = VIR_DOMAIN_BLOCK_COMMIT_ACTIVE
	DOMAIN_BLOCK_COMMIT_BANDWIDTH_BYTES                                                     = VIR_DOMAIN_BLOCK_COMMIT_BANDWIDTH_BYTES
	DOMAIN_BLOCK_COMMIT_DELETE                                                              = VIR_DOMAIN_BLOCK_COMMIT_DELETE
	DOMAIN_BLOCK_COMMIT_RELATIVE                                                            = VIR_DOMAIN_BLOCK_COMMIT_RELATIVE
	DOMAIN_BLOCK_COMMIT_SHALLOW                                                             = VIR_DOMAIN_BLOCK_COMMIT_SHALLOW
	DOMAIN_BLOCK_COPY_REUSE_EXT                                                             = VIR_DOMAIN_BLOCK_COPY_REUSE_EXT
	DOMAIN_BLOCK_COPY_SHALLOW                                                               = VIR_DOMAIN_BLOCK_COPY_SHALLOW
	DOMAIN_BLOCK_COPY_SYNCHRONOUS_WRITES                                                    = VIR_DOMAIN_BLOCK_COPY_SYNCHRONOUS_WRITES
	DOMAIN_BLOCK_COPY_TARGET_ZEROED                                                         = VIR_DOMAIN_BLOCK_COPY_TARGET_ZEROED
	DOMAIN_BLOCK_COPY_TRANSIENT_JOB                                                         = VIR_DOMAIN_BLOCK_COPY_TRANSIENT_JOB
	DOMAIN_BLOCK_JOB_ABORT_ASYNC                                                            = VIR_DOMAIN_BLOCK_JOB_ABORT_ASYNC
	DOMAIN_BLOCK_JOB_ABORT_PIVOT                                                            = VIR_DOMAIN_BLOCK_JOB_ABORT_PIVOT
	DOMAIN_BLOCK_JOB_CANCELED                                                               = VIR_DOMAIN_BLOCK_JOB_CANCELED
	DOMAIN_BLOCK_JOB_COMPLETED                                                              = VIR_DOMAIN_BLOCK_JOB_COMPLETED
	DOMAIN_BLOCK_JOB_FAILED                                                                 = VIR_DOMAIN_BLOCK_JOB_FAILED
	DOMAIN_BLOCK_JOB_INFO_BANDWIDTH_BYTES                                                   = VIR_DOMAIN_BLOCK_JOB_INFO_BANDWIDTH_BYTES
	DOMAIN_BLOCK_JOB_LAST                                                                   = VIR_DOMAIN_BLOCK_JOB_LAST
	DOMAIN_BLOCK_JOB_READY                                                                  = VIR_DOMAIN_BLOCK_JOB_READY
	DOMAIN_BLOCK_JOB_SPEED_BANDWIDTH_BYTES                                                  = VIR_DOMAIN_BLOCK_JOB_SPEED_BANDWIDTH_BYTES
	DOMAIN_BLOCK_JOB_TYPE_ACTIVE_COMMIT                                                     = VIR_DOMAIN_BLOCK_JOB_TYPE_ACTIVE_COMMIT
	DOMAIN_BLOCK_JOB_TYPE_BACKUP                                                            = VIR_DOMAIN_BLOCK_JOB_TYPE_BACKUP
	DOMAIN_BLOCK_JOB_TYPE_COMMIT                                                            = VIR_DOMAIN_BLOCK_JOB_TYPE_COMMIT
	DOMAIN_BLOCK_JOB_TYPE_COPY                                                              = VIR_DOMAIN_BLOCK_JOB_TYPE_COPY
	DOMAIN_BLOCK_JOB_TYPE_LAST                                                              = VIR_DOMAIN_BLOCK_JOB_TYPE_LAST
	DOMAIN_BLOCK_JOB_TYPE_PULL                                                              = VIR_DOMAIN_BLOCK_JOB_TYPE_PULL
	DOMAIN_BLOCK_JOB_TYPE_UNKNOWN                                                           = VIR_DOMAIN_BLOCK_JOB_TYPE_UNKNOWN
	DOMAIN_BLOCK_PULL_BANDWIDTH_BYTES                                                       = VIR_DOMAIN_BLOCK_PULL_BANDWIDTH_BYTES
	DOMAIN_BLOCK_REBASE_BANDWIDTH_BYTES                                                     = VIR_DOMAIN_BLOCK_REBASE_BANDWIDTH_BYTES
	DOMAIN_BLOCK_REBASE_COPY                                                                = VIR_DOMAIN_BLOCK_REBASE_COPY
	DOMAIN_BLOCK_REBASE_COPY_DEV                                                            = VIR_DOMAIN_BLOCK_REBASE_COPY_DEV
	DOMAIN_BLOCK_REBASE_COPY_RAW                                                            = VIR_DOMAIN_BLOCK_REBASE_COPY_RAW
	DOMAIN_BLOCK_REBASE_RELATIVE                                                            = VIR_DOMAIN_BLOCK_REBASE_RELATIVE
	DOMAIN_BLOCK_REBASE_REUSE_EXT                                                           = VIR_DOMAIN_BLOCK_REBASE_REUSE_EXT
	DOMAIN_BLOCK_REBASE_SHALLOW                                                             = VIR_DOMAIN_BLOCK_REBASE_SHALLOW
	DOMAIN_BLOCK_RESIZE_BYTES                                                               = VIR_DOMAIN_BLOCK_RESIZE_BYTES
	DOMAIN_BLOCK_RESIZE_CAPACITY                                                            = VIR_DOMAIN_BLOCK_RESIZE_CAPACITY
	DOMAIN_BLOCK_RESIZE_EXTEND                                                              = VIR_DOMAIN_BLOCK_RESIZE_EXTEND
	DOMAIN_CHANNEL_FORCE                                                                    = VIR_DOMAIN_CHANNEL_FORCE
	DOMAIN_CHECKPOINT_CREATE_QUIESCE                                                        = VIR_DOMAIN_CHECKPOINT_CREATE_QUIESCE
	DOMAIN_CHECKPOINT_CREATE_REDEFINE                                                       = VIR_DOMAIN_CHECKPOINT_CREATE_REDEFINE
	DOMAIN_CHECKPOINT_CREATE_REDEFINE_VALIDATE                                              = VIR_DOMAIN_CHECKPOINT_CREATE_REDEFINE_VALIDATE
	DOMAIN_CHECKPOINT_DELETE_CHILDREN                                                       = VIR_DOMAIN_CHECKPOINT_DELETE_CHILDREN
	DOMAIN_CHECKPOINT_DELETE_CHILDREN_ONLY                                                  = VIR_DOMAIN_CHECKPOINT_DELETE_CHILDREN_ONLY
	DOMAIN_CHECKPOINT_DELETE_METADATA_ONLY                                                  = VIR_DOMAIN_CHECKPOINT_DELETE_METADATA_ONLY
	DOMAIN_CHECKPOINT_LIST_DESCENDANTS                                                      = VIR_DOMAIN_CHECKPOINT_LIST_DESCENDANTS
	DOMAIN_CHECKPOINT_LIST_LEAVES                                                           = VIR_DOMAIN_CHECKPOINT_LIST_LEAVES
	DOMAIN_CHECKPOINT_LIST_NO_LEAVES                                                        = VIR_DOMAIN_CHECKPOINT_LIST_NO_LEAVES
	DOMAIN_CHECKPOINT_LIST_ROOTS                                                            = VIR_DOMAIN_CHECKPOINT_LIST_ROOTS
	DOMAIN_CHECKPOINT_LIST_TOPOLOGICAL                                                      = VIR_DOMAIN_CHECKPOINT_LIST_TOPOLOGICAL
	DOMAIN_CHECKPOINT_XML_NO_DOMAIN                                                         = VIR_DOMAIN_CHECKPOINT_XML_NO_DOMAIN
	DOMAIN_CHECKPOINT_XML_SECURE                                                            = VIR_DOMAIN_CHECKPOINT_XML_SECURE
	DOMAIN_CHECKPOINT_XML_SIZE                                                              = VIR_DOMAIN_CHECKPOINT_XML_SIZE
	DOMAIN_CONSOLE_FORCE                                                                    = VIR_DOMAIN_CONSOLE_FORCE
	DOMAIN_CONSOLE_SAFE                                                                     = VIR_DOMAIN_CONSOLE_SAFE
	DOMAIN_CONTROL_ERROR                                                                    = VIR_DOMAIN_CONTROL_ERROR
	DOMAIN_CONTROL_ERROR_REASON_INTERNAL                                                    = VIR_DOMAIN_CONTROL_ERROR_REASON_INTERNAL
	DOMAIN_CONTROL_ERROR_REASON_LAST                                                        = VIR_DOMAIN_CONTROL_ERROR_REASON_LAST
	DOMAIN_CONTROL_ERROR_REASON_MONITOR                                                     = VIR_DOMAIN_CONTROL_ERROR_REASON_MONITOR
	DOMAIN_CONTROL_ERROR_REASON_NONE                                                        = VIR_DOMAIN_CONTROL_ERROR_REASON_NONE
	DOMAIN_CONTROL_ERROR_REASON_UNKNOWN                                                     = VIR_DOMAIN_CONTROL_ERROR_REASON_UNKNOWN
	DOMAIN_CONTROL_JOB                                                                      = VIR_DOMAIN_CONTROL_JOB
	DOMAIN_CONTROL_LAST                                                                     = VIR_DOMAIN_CONTROL_LAST
	DOMAIN_CONTROL_OCCUPIED                                                                 = VIR_DOMAIN_CONTROL_OCCUPIED
	DOMAIN_CONTROL_OK                                                                       = VIR_DOMAIN_CONTROL_OK
	DOMAIN_CORE_DUMP_FORMAT_KDUMP_LZO                                                       = VIR_DOMAIN_CORE_DUMP_FORMAT_KDUMP_LZO
	DOMAIN_CORE_DUMP_FORMAT_KDUMP_SNAPPY                                                    = VIR_DOMAIN_CORE_DUMP_FORMAT_KDUMP_SNAPPY
	DOMAIN_CORE_DUMP_FORMAT_KDUMP_ZLIB                                                      = VIR_DOMAIN_CORE_DUMP_FORMAT_KDUMP_ZLIB
	DOMAIN_CORE_DUMP_FORMAT_LAST                                                            = VIR_DOMAIN_CORE_DUMP_FORMAT_LAST
	DOMAIN_CORE_DUMP_FORMAT_RAW                                                             = VIR_DOMAIN_CORE_DUMP_FORMAT_RAW
	DOMAIN_CORE_DUMP_FORMAT_WIN_DMP                                                         = VIR_DOMAIN_CORE_DUMP_FORMAT_WIN_DMP
	DOMAIN_CRASHED                                               DomainState                = DomainState(VIR_DOMAIN_CRASHED)
	DOMAIN_CRASHED_LAST                                                                     = VIR_DOMAIN_CRASHED_LAST
	DOMAIN_CRASHED_PANICKED                                                                 = VIR_DOMAIN_CRASHED_PANICKED
	DOMAIN_CRASHED_UNKNOWN                                                                  = VIR_DOMAIN_CRASHED_UNKNOWN
	DOMAIN_DEFINE_VALIDATE                                                                  = VIR_DOMAIN_DEFINE_VALIDATE
	DOMAIN_DESTROY_DEFAULT                                                                  = VIR_DOMAIN_DESTROY_DEFAULT
	DOMAIN_DESTROY_GRACEFUL                                                                 = VIR_DOMAIN_DESTROY_GRACEFUL
	DOMAIN_DESTROY_REMOVE_LOGS                                                              = VIR_DOMAIN_DESTROY_REMOVE_LOGS
	DOMAIN_DEVICE_MODIFY_CONFIG                                  DomainDeviceModifyFlags    = DomainDeviceModifyFlags(VIR_DOMAIN_DEVICE_MODIFY_CONFIG)
	DOMAIN_DEVICE_MODIFY_CURRENT                                 DomainDeviceModifyFlags    = DomainDeviceModifyFlags(VIR_DOMAIN_DEVICE_MODIFY_CURRENT)
	DOMAIN_DEVICE_MODIFY_FORCE                                   DomainDeviceModifyFlags    = DomainDeviceModifyFlags(VIR_DOMAIN_DEVICE_MODIFY_FORCE)
	DOMAIN_DEVICE_MODIFY_LIVE                                    DomainDeviceModifyFlags    = DomainDeviceModifyFlags(VIR_DOMAIN_DEVICE_MODIFY_LIVE)
	DOMAIN_DIRTYRATE_LAST                                                                   = VIR_DOMAIN_DIRTYRATE_LAST
	DOMAIN_DIRTYRATE_MEASURED                                                               = VIR_DOMAIN_DIRTYRATE_MEASURED
	DOMAIN_DIRTYRATE_MEASURING                                                              = VIR_DOMAIN_DIRTYRATE_MEASURING
	DOMAIN_DIRTYRATE_MODE_DIRTY_BITMAP                                                      = VIR_DOMAIN_DIRTYRATE_MODE_DIRTY_BITMAP
	DOMAIN_DIRTYRATE_MODE_DIRTY_RING                                                        = VIR_DOMAIN_DIRTYRATE_MODE_DIRTY_RING
	DOMAIN_DIRTYRATE_MODE_PAGE_SAMPLING                                                     = VIR_DOMAIN_DIRTYRATE_MODE_PAGE_SAMPLING
	DOMAIN_DIRTYRATE_UNSTARTED                                                              = VIR_DOMAIN_DIRTYRATE_UNSTARTED
	DOMAIN_DISK_ERROR_LAST                                                                  = VIR_DOMAIN_DISK_ERROR_LAST
	DOMAIN_DISK_ERROR_NONE                                                                  = VIR_DOMAIN_DISK_ERROR_NONE
	DOMAIN_DISK_ERROR_NO_SPACE                                                              = VIR_DOMAIN_DISK_ERROR_NO_SPACE
	DOMAIN_DISK_ERROR_UNSPEC                                                                = VIR_DOMAIN_DISK_ERROR_UNSPEC
	DOMAIN_EVENT_CRASHED                                                                    = VIR_DOMAIN_EVENT_CRASHED
	DOMAIN_EVENT_CRASHED_CRASHLOADED                                                        = VIR_DOMAIN_EVENT_CRASHED_CRASHLOADED
	DOMAIN_EVENT_CRASHED_LAST                                                               = VIR_DOMAIN_EVENT_CRASHED_LAST
	DOMAIN_EVENT_CRASHED_PANICKED                                                           = VIR_DOMAIN_EVENT_CRASHED_PANICKED
	DOMAIN_EVENT_DEFINED                                                                    = VIR_DOMAIN_EVENT_DEFINED
	DOMAIN_EVENT_DEFINED_ADDED                                                              = VIR_DOMAIN_EVENT_DEFINED_ADDED
	DOMAIN_EVENT_DEFINED_FROM_SNAPSHOT                                                      = VIR_DOMAIN_EVENT_DEFINED_FROM_SNAPSHOT
	DOMAIN_EVENT_DEFINED_LAST                                                               = VIR_DOMAIN_EVENT_DEFINED_LAST
	DOMAIN_EVENT_DEFINED_RENAMED                                                            = VIR_DOMAIN_EVENT_DEFINED_RENAMED
	DOMAIN_EVENT_DEFINED_UPDATED                                                            = VIR_DOMAIN_EVENT_DEFINED_UPDATED
	DOMAIN_EVENT_DISK_CHANGE_LAST                                                           = VIR_DOMAIN_EVENT_DISK_CHANGE_LAST
	DOMAIN_EVENT_DISK_CHANGE_MISSING_ON_START                                               = VIR_DOMAIN_EVENT_DISK_CHANGE_MISSING_ON_START
	DOMAIN_EVENT_DISK_DROP_MISSING_ON_START                                                 = VIR_DOMAIN_EVENT_DISK_DROP_MISSING_ON_START
	DOMAIN_EVENT_GRAPHICS_ADDRESS_IPV4                                                      = VIR_DOMAIN_EVENT_GRAPHICS_ADDRESS_IPV4
	DOMAIN_EVENT_GRAPHICS_ADDRESS_IPV6                                                      = VIR_DOMAIN_EVENT_GRAPHICS_ADDRESS_IPV6
	DOMAIN_EVENT_GRAPHICS_ADDRESS_LAST                                                      = VIR_DOMAIN_EVENT_GRAPHICS_ADDRESS_LAST
	DOMAIN_EVENT_GRAPHICS_ADDRESS_UNIX                                                      = VIR_DOMAIN_EVENT_GRAPHICS_ADDRESS_UNIX
	DOMAIN_EVENT_GRAPHICS_CONNECT                                                           = VIR_DOMAIN_EVENT_GRAPHICS_CONNECT
	DOMAIN_EVENT_GRAPHICS_DISCONNECT                                                        = VIR_DOMAIN_EVENT_GRAPHICS_DISCONNECT
	DOMAIN_EVENT_GRAPHICS_INITIALIZE                                                        = VIR_DOMAIN_EVENT_GRAPHICS_INITIALIZE
	DOMAIN_EVENT_GRAPHICS_LAST                                                              = VIR_DOMAIN_EVENT_GRAPHICS_LAST
	DOMAIN_EVENT_ID_AGENT_LIFECYCLE                                                         = VIR_DOMAIN_EVENT_ID_AGENT_LIFECYCLE
	DOMAIN_EVENT_ID_BALLOON_CHANGE                                                          = VIR_DOMAIN_EVENT_ID_BALLOON_CHANGE
	DOMAIN_EVENT_ID_BLOCK_JOB                                                               = VIR_DOMAIN_EVENT_ID_BLOCK_JOB
	DOMAIN_EVENT_ID_BLOCK_JOB_2                                                             = VIR_DOMAIN_EVENT_ID_BLOCK_JOB_2
	DOMAIN_EVENT_ID_BLOCK_THRESHOLD                                                         = VIR_DOMAIN_EVENT_ID_BLOCK_THRESHOLD
	DOMAIN_EVENT_ID_CHANNEL_LIFECYCLE                                                       = VIR_DOMAIN_EVENT_ID_CHANNEL_LIFECYCLE
	DOMAIN_EVENT_ID_CONTROL_ERROR                                                           = VIR_DOMAIN_EVENT_ID_CONTROL_ERROR
	DOMAIN_EVENT_ID_DEVICE_ADDED                                                            = VIR_DOMAIN_EVENT_ID_DEVICE_ADDED
	DOMAIN_EVENT_ID_DEVICE_REMOVAL_FAILED                                                   = VIR_DOMAIN_EVENT_ID_DEVICE_REMOVAL_FAILED
	DOMAIN_EVENT_ID_DEVICE_REMOVED                                                          = VIR_DOMAIN_EVENT_ID_DEVICE_REMOVED
	DOMAIN_EVENT_ID_DISK_CHANGE                                                             = VIR_DOMAIN_EVENT_ID_DISK_CHANGE
	DOMAIN_EVENT_ID_GRAPHICS                                                                = VIR_DOMAIN_EVENT_ID_GRAPHICS
	DOMAIN_EVENT_ID_IO_ERROR                                                                = VIR_DOMAIN_EVENT_ID_IO_ERROR
	DOMAIN_EVENT_ID_IO_ERROR_REASON                                                         = VIR_DOMAIN_EVENT_ID_IO_ERROR_REASON
	DOMAIN_EVENT_ID_JOB_COMPLETED                                                           = VIR_DOMAIN_EVENT_ID_JOB_COMPLETED
	DOMAIN_EVENT_ID_LAST                                                                    = VIR_DOMAIN_EVENT_ID_LAST
	DOMAIN_EVENT_ID_LIFECYCLE                                                               = VIR_DOMAIN_EVENT_ID_LIFECYCLE
	DOMAIN_EVENT_ID_MEMORY_DEVICE_SIZE_CHANGE                                               = VIR_DOMAIN_EVENT_ID_MEMORY_DEVICE_SIZE_CHANGE
	DOMAIN_EVENT_ID_MEMORY_FAILURE                                                          = VIR_DOMAIN_EVENT_ID_MEMORY_FAILURE
	DOMAIN_EVENT_ID_METADATA_CHANGE                                                         = VIR_DOMAIN_EVENT_ID_METADATA_CHANGE
	DOMAIN_EVENT_ID_MIGRATION_ITERATION                                                     = VIR_DOMAIN_EVENT_ID_MIGRATION_ITERATION
	DOMAIN_EVENT_ID_NIC_MAC_CHANGE                                                          = VIR_DOMAIN_EVENT_ID_NIC_MAC_CHANGE
	DOMAIN_EVENT_ID_PMSUSPEND                                                               = VIR_DOMAIN_EVENT_ID_PMSUSPEND
	DOMAIN_EVENT_ID_PMSUSPEND_DISK                                                          = VIR_DOMAIN_EVENT_ID_PMSUSPEND_DISK
	DOMAIN_EVENT_ID_PMWAKEUP                                                                = VIR_DOMAIN_EVENT_ID_PMWAKEUP
	DOMAIN_EVENT_ID_REBOOT                                                                  = VIR_DOMAIN_EVENT_ID_REBOOT
	DOMAIN_EVENT_ID_RTC_CHANGE                                                              = VIR_DOMAIN_EVENT_ID_RTC_CHANGE
	DOMAIN_EVENT_ID_TRAY_CHANGE                                                             = VIR_DOMAIN_EVENT_ID_TRAY_CHANGE
	DOMAIN_EVENT_ID_TUNABLE                                                                 = VIR_DOMAIN_EVENT_ID_TUNABLE
	DOMAIN_EVENT_ID_VCPU_REMOVED                                                            = VIR_DOMAIN_EVENT_ID_VCPU_REMOVED
	DOMAIN_EVENT_ID_WATCHDOG                                                                = VIR_DOMAIN_EVENT_ID_WATCHDOG
	DOMAIN_EVENT_IO_ERROR_LAST                                                              = VIR_DOMAIN_EVENT_IO_ERROR_LAST
	DOMAIN_EVENT_IO_ERROR_NONE                                                              = VIR_DOMAIN_EVENT_IO_ERROR_NONE
	DOMAIN_EVENT_IO_ERROR_PAUSE                                                             = VIR_DOMAIN_EVENT_IO_ERROR_PAUSE
	DOMAIN_EVENT_IO_ERROR_REPORT                                                            = VIR_DOMAIN_EVENT_IO_ERROR_REPORT
	DOMAIN_EVENT_LAST                                                                       = VIR_DOMAIN_EVENT_LAST
	DOMAIN_EVENT_MEMORY_FAILURE_ACTION_FATAL                                                = VIR_DOMAIN_EVENT_MEMORY_FAILURE_ACTION_FATAL
	DOMAIN_EVENT_MEMORY_FAILURE_ACTION_IGNORE                                               = VIR_DOMAIN_EVENT_MEMORY_FAILURE_ACTION_IGNORE
	DOMAIN_EVENT_MEMORY_FAILURE_ACTION_INJECT                                               = VIR_DOMAIN_EVENT_MEMORY_FAILURE_ACTION_INJECT
	DOMAIN_EVENT_MEMORY_FAILURE_ACTION_LAST                                                 = VIR_DOMAIN_EVENT_MEMORY_FAILURE_ACTION_LAST
	DOMAIN_EVENT_MEMORY_FAILURE_ACTION_RESET                                                = VIR_DOMAIN_EVENT_MEMORY_FAILURE_ACTION_RESET
	DOMAIN_EVENT_MEMORY_FAILURE_RECIPIENT_GUEST                                             = VIR_DOMAIN_EVENT_MEMORY_FAILURE_RECIPIENT_GUEST
	DOMAIN_EVENT_MEMORY_FAILURE_RECIPIENT_HYPERVISOR                                        = VIR_DOMAIN_EVENT_MEMORY_FAILURE_RECIPIENT_HYPERVISOR
	DOMAIN_EVENT_MEMORY_FAILURE_RECIPIENT_LAST                                              = VIR_DOMAIN_EVENT_MEMORY_FAILURE_RECIPIENT_LAST
	DOMAIN_EVENT_PMSUSPENDED                                                                = VIR_DOMAIN_EVENT_PMSUSPENDED
	DOMAIN_EVENT_PMSUSPENDED_DISK                                                           = VIR_DOMAIN_EVENT_PMSUSPENDED_DISK
	DOMAIN_EVENT_PMSUSPENDED_LAST                                                           = VIR_DOMAIN_EVENT_PMSUSPENDED_LAST
	DOMAIN_EVENT_PMSUSPENDED_MEMORY                                                         = VIR_DOMAIN_EVENT_PMSUSPENDED_MEMORY
	DOMAIN_EVENT_RESUMED                                                                    = VIR_DOMAIN_EVENT_RESUMED
	DOMAIN_EVENT_RESUMED_FROM_SNAPSHOT                                                      = VIR_DOMAIN_EVENT_RESUMED_FROM_SNAPSHOT
	DOMAIN_EVENT_RESUMED_LAST                                                               = VIR_DOMAIN_EVENT_RESUMED_LAST
	DOMAIN_EVENT_RESUMED_MIGRATED                                                           = VIR_DOMAIN_EVENT_RESUMED_MIGRATED
	DOMAIN_EVENT_RESUMED_POSTCOPY                                                           = VIR_DOMAIN_EVENT_RESUMED_POSTCOPY
	DOMAIN_EVENT_RESUMED_POSTCOPY_FAILED                                                    = VIR_DOMAIN_EVENT_RESUMED_POSTCOPY_FAILED
	DOMAIN_EVENT_RESUMED_UNPAUSED                                                           = VIR_DOMAIN_EVENT_RESUMED_UNPAUSED
	DOMAIN_EVENT_SHUTDOWN                                                                   = VIR_DOMAIN_EVENT_SHUTDOWN
	DOMAIN_EVENT_SHUTDOWN_FINISHED                                                          = VIR_DOMAIN_EVENT_SHUTDOWN_FINISHED
	DOMAIN_EVENT_SHUTDOWN_GUEST                                                             = VIR_DOMAIN_EVENT_SHUTDOWN_GUEST
	DOMAIN_EVENT_SHUTDOWN_HOST                                                              = VIR_DOMAIN_EVENT_SHUTDOWN_HOST
	DOMAIN_EVENT_SHUTDOWN_LAST                                                              = VIR_DOMAIN_EVENT_SHUTDOWN_LAST
	DOMAIN_EVENT_STARTED                                                                    = VIR_DOMAIN_EVENT_STARTED
	DOMAIN_EVENT_STARTED_BOOTED                                                             = VIR_DOMAIN_EVENT_STARTED_BOOTED
	DOMAIN_EVENT_STARTED_FROM_SNAPSHOT                                                      = VIR_DOMAIN_EVENT_STARTED_FROM_SNAPSHOT
	DOMAIN_EVENT_STARTED_LAST                                                               = VIR_DOMAIN_EVENT_STARTED_LAST
	DOMAIN_EVENT_STARTED_MIGRATED                                                           = VIR_DOMAIN_EVENT_STARTED_MIGRATED
	DOMAIN_EVENT_STARTED_RECREATED                                                          = VIR_DOMAIN_EVENT_STARTED_RECREATED
	DOMAIN_EVENT_STARTED_RESTORED                                                           = VIR_DOMAIN_EVENT_STARTED_RESTORED
	DOMAIN_EVENT_STARTED_WAKEUP                                                             = VIR_DOMAIN_EVENT_STARTED_WAKEUP
	DOMAIN_EVENT_STOPPED                                                                    = VIR_DOMAIN_EVENT_STOPPED
	DOMAIN_EVENT_STOPPED_CRASHED                                                            = VIR_DOMAIN_EVENT_STOPPED_CRASHED
	DOMAIN_EVENT_STOPPED_DESTROYED                                                          = VIR_DOMAIN_EVENT_STOPPED_DESTROYED
	DOMAIN_EVENT_STOPPED_FAILED                                                             = VIR_DOMAIN_EVENT_STOPPED_FAILED
	DOMAIN_EVENT_STOPPED_FROM_SNAPSHOT                                                      = VIR_DOMAIN_EVENT_STOPPED_FROM_SNAPSHOT
	DOMAIN_EVENT_STOPPED_LAST                                                               = VIR_DOMAIN_EVENT_STOPPED_LAST
	DOMAIN_EVENT_STOPPED_MIGRATED                                                           = VIR_DOMAIN_EVENT_STOPPED_MIGRATED
	DOMAIN_EVENT_STOPPED_RECREATED                                                          = VIR_DOMAIN_EVENT_STOPPED_RECREATED
	DOMAIN_EVENT_STOPPED_SAVED                                                              = VIR_DOMAIN_EVENT_STOPPED_SAVED
	DOMAIN_EVENT_STOPPED_SHUTDOWN                                                           = VIR_DOMAIN_EVENT_STOPPED_SHUTDOWN
	DOMAIN_EVENT_SUSPENDED                                                                  = VIR_DOMAIN_EVENT_SUSPENDED
	DOMAIN_EVENT_SUSPENDED_API_ERROR                                                        = VIR_DOMAIN_EVENT_SUSPENDED_API_ERROR
	DOMAIN_EVENT_SUSPENDED_FROM_SNAPSHOT                                                    = VIR_DOMAIN_EVENT_SUSPENDED_FROM_SNAPSHOT
	DOMAIN_EVENT_SUSPENDED_GUEST_SHUTDOWN                                                   = VIR_DOMAIN_EVENT_SUSPENDED_GUEST_SHUTDOWN
	DOMAIN_EVENT_SUSPENDED_IOERROR                                                          = VIR_DOMAIN_EVENT_SUSPENDED_IOERROR
	DOMAIN_EVENT_SUSPENDED_LAST                                                             = VIR_DOMAIN_EVENT_SUSPENDED_LAST
	DOMAIN_EVENT_SUSPENDED_MIGRATED                                                         = VIR_DOMAIN_EVENT_SUSPENDED_MIGRATED
	DOMAIN_EVENT_SUSPENDED_PAUSED                                                           = VIR_DOMAIN_EVENT_SUSPENDED_PAUSED
	DOMAIN_EVENT_SUSPENDED_POSTCOPY                                                         = VIR_DOMAIN_EVENT_SUSPENDED_POSTCOPY
	DOMAIN_EVENT_SUSPENDED_POSTCOPY_FAILED                                                  = VIR_DOMAIN_EVENT_SUSPENDED_POSTCOPY_FAILED
	DOMAIN_EVENT_SUSPENDED_RESTORED                                                         = VIR_DOMAIN_EVENT_SUSPENDED_RESTORED
	DOMAIN_EVENT_SUSPENDED_WATCHDOG                                                         = VIR_DOMAIN_EVENT_SUSPENDED_WATCHDOG
	DOMAIN_EVENT_TRAY_CHANGE_CLOSE                                                          = VIR_DOMAIN_EVENT_TRAY_CHANGE_CLOSE
	DOMAIN_EVENT_TRAY_CHANGE_LAST                                                           = VIR_DOMAIN_EVENT_TRAY_CHANGE_LAST
	DOMAIN_EVENT_TRAY_CHANGE_OPEN                                                           = VIR_DOMAIN_EVENT_TRAY_CHANGE_OPEN
	DOMAIN_EVENT_UNDEFINED                                                                  = VIR_DOMAIN_EVENT_UNDEFINED
	DOMAIN_EVENT_UNDEFINED_LAST                                                             = VIR_DOMAIN_EVENT_UNDEFINED_LAST
	DOMAIN_EVENT_UNDEFINED_REMOVED                                                          = VIR_DOMAIN_EVENT_UNDEFINED_REMOVED
	DOMAIN_EVENT_UNDEFINED_RENAMED                                                          = VIR_DOMAIN_EVENT_UNDEFINED_RENAMED
	DOMAIN_EVENT_WATCHDOG_DEBUG                                                             = VIR_DOMAIN_EVENT_WATCHDOG_DEBUG
	DOMAIN_EVENT_WATCHDOG_INJECTNMI                                                         = VIR_DOMAIN_EVENT_WATCHDOG_INJECTNMI
	DOMAIN_EVENT_WATCHDOG_LAST                                                              = VIR_DOMAIN_EVENT_WATCHDOG_LAST
	DOMAIN_EVENT_WATCHDOG_NONE                                                              = VIR_DOMAIN_EVENT_WATCHDOG_NONE
	DOMAIN_EVENT_WATCHDOG_PAUSE                                                             = VIR_DOMAIN_EVENT_WATCHDOG_PAUSE
	DOMAIN_EVENT_WATCHDOG_POWEROFF                                                          = VIR_DOMAIN_EVENT_WATCHDOG_POWEROFF
	DOMAIN_EVENT_WATCHDOG_RESET                                                             = VIR_DOMAIN_EVENT_WATCHDOG_RESET
	DOMAIN_EVENT_WATCHDOG_SHUTDOWN                                                          = VIR_DOMAIN_EVENT_WATCHDOG_SHUTDOWN
	DOMAIN_FD_ASSOCIATE_SECLABEL_RESTORE                                                    = VIR_DOMAIN_FD_ASSOCIATE_SECLABEL_RESTORE
	DOMAIN_FD_ASSOCIATE_SECLABEL_WRITABLE                                                   = VIR_DOMAIN_FD_ASSOCIATE_SECLABEL_WRITABLE
	DOMAIN_GET_HOSTNAME_AGENT                                                               = VIR_DOMAIN_GET_HOSTNAME_AGENT
	DOMAIN_GET_HOSTNAME_LEASE                                                               = VIR_DOMAIN_GET_HOSTNAME_LEASE
	DOMAIN_GRAPHICS_RELOAD_TYPE_ANY                                                         = VIR_DOMAIN_GRAPHICS_RELOAD_TYPE_ANY
	DOMAIN_GRAPHICS_RELOAD_TYPE_LAST                                                        = VIR_DOMAIN_GRAPHICS_RELOAD_TYPE_LAST
	DOMAIN_GRAPHICS_RELOAD_TYPE_VNC                                                         = VIR_DOMAIN_GRAPHICS_RELOAD_TYPE_VNC
	DOMAIN_GUEST_INFO_DISKS                                                                 = VIR_DOMAIN_GUEST_INFO_DISKS
	DOMAIN_GUEST_INFO_FILESYSTEM                                                            = VIR_DOMAIN_GUEST_INFO_FILESYSTEM
	DOMAIN_GUEST_INFO_HOSTNAME                                                              = VIR_DOMAIN_GUEST_INFO_HOSTNAME
	DOMAIN_GUEST_INFO_INTERFACES                                                            = VIR_DOMAIN_GUEST_INFO_INTERFACES
	DOMAIN_GUEST_INFO_LOAD                                                                  = VIR_DOMAIN_GUEST_INFO_LOAD
	DOMAIN_GUEST_INFO_OS                                                                    = VIR_DOMAIN_GUEST_INFO_OS
	DOMAIN_GUEST_INFO_TIMEZONE                                                              = VIR_DOMAIN_GUEST_INFO_TIMEZONE
	DOMAIN_GUEST_INFO_USERS                                                                 = VIR_DOMAIN_GUEST_INFO_USERS
	DOMAIN_INTERFACE_ADDRESSES_SRC_AGENT                                                    = VIR_DOMAIN_INTERFACE_ADDRESSES_SRC_AGENT
	DOMAIN_INTERFACE_ADDRESSES_SRC_ARP                                                      = VIR_DOMAIN_INTERFACE_ADDRESSES_SRC_ARP
	DOMAIN_INTERFACE_ADDRESSES_SRC_LAST                                                     = VIR_DOMAIN_INTERFACE_ADDRESSES_SRC_LAST
	DOMAIN_INTERFACE_ADDRESSES_SRC_LEASE                                                    = VIR_DOMAIN_INTERFACE_ADDRESSES_SRC_LEASE
	DOMAIN_JOB_BOUNDED                                           DomainJobType              = DomainJobType(VIR_DOMAIN_JOB_BOUNDED)
	DOMAIN_JOB_CANCELLED                                         DomainJobType              = DomainJobType(VIR_DOMAIN_JOB_CANCELLED)
	DOMAIN_JOB_COMPLETED                                         DomainJobType              = DomainJobType(VIR_DOMAIN_JOB_COMPLETED)
	DOMAIN_JOB_FAILED                                            DomainJobType              = DomainJobType(VIR_DOMAIN_JOB_FAILED)
	DOMAIN_JOB_LAST                                              DomainJobType              = DomainJobType(VIR_DOMAIN_JOB_LAST)
	DOMAIN_JOB_NONE                                              DomainJobType              = DomainJobType(VIR_DOMAIN_JOB_NONE)
	DOMAIN_JOB_OPERATION_BACKUP                                  DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_BACKUP)
	DOMAIN_JOB_OPERATION_DUMP                                    DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_DUMP)
	DOMAIN_JOB_OPERATION_LAST                                    DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_LAST)
	DOMAIN_JOB_OPERATION_MIGRATION_IN                            DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_MIGRATION_IN)
	DOMAIN_JOB_OPERATION_MIGRATION_OUT                           DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_MIGRATION_OUT)
	DOMAIN_JOB_OPERATION_RESTORE                                 DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_RESTORE)
	DOMAIN_JOB_OPERATION_SAVE                                    DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_SAVE)
	DOMAIN_JOB_OPERATION_SNAPSHOT                                DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_SNAPSHOT)
	DOMAIN_JOB_OPERATION_SNAPSHOT_DELETE                         DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_SNAPSHOT_DELETE)
	DOMAIN_JOB_OPERATION_SNAPSHOT_REVERT                         DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_SNAPSHOT_REVERT)
	DOMAIN_JOB_OPERATION_START                                   DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_START)
	DOMAIN_JOB_OPERATION_UNKNOWN                                 DomainJobOperationType     = DomainJobOperationType(VIR_DOMAIN_JOB_OPERATION_UNKNOWN)
	DOMAIN_JOB_STATS_COMPLETED                                   DomainGetJobStatsFlags     = DomainGetJobStatsFlags(VIR_DOMAIN_JOB_STATS_COMPLETED)
	DOMAIN_JOB_STATS_KEEP_COMPLETED                              DomainGetJobStatsFlags     = DomainGetJobStatsFlags(VIR_DOMAIN_JOB_STATS_KEEP_COMPLETED)
	DOMAIN_JOB_UNBOUNDED                                         DomainJobType              = DomainJobType(VIR_DOMAIN_JOB_UNBOUNDED)
	DOMAIN_LAST                                                  DomainState                = DomainState(VIR_DOMAIN_LAST)
	DOMAIN_LIFECYCLE_ACTION_COREDUMP_DESTROY                                                = VIR_DOMAIN_LIFECYCLE_ACTION_COREDUMP_DESTROY
	DOMAIN_LIFECYCLE_ACTION_COREDUMP_RESTART                                                = VIR_DOMAIN_LIFECYCLE_ACTION_COREDUMP_RESTART
	DOMAIN_LIFECYCLE_ACTION_DESTROY                                                         = VIR_DOMAIN_LIFECYCLE_ACTION_DESTROY
	DOMAIN_LIFECYCLE_ACTION_LAST                                                            = VIR_DOMAIN_LIFECYCLE_ACTION_LAST
	DOMAIN_LIFECYCLE_ACTION_PRESERVE                                                        = VIR_DOMAIN_LIFECYCLE_ACTION_PRESERVE
	DOMAIN_LIFECYCLE_ACTION_PRESERVE_RUNNING                                                = VIR_DOMAIN_LIFECYCLE_ACTION_PRESERVE_RUNNING
	DOMAIN_LIFECYCLE_ACTION_RESTART                                                         = VIR_DOMAIN_LIFECYCLE_ACTION_RESTART
	DOMAIN_LIFECYCLE_ACTION_RESTART_RENAME                                                  = VIR_DOMAIN_LIFECYCLE_ACTION_RESTART_RENAME
	DOMAIN_LIFECYCLE_CRASH                                                                  = VIR_DOMAIN_LIFECYCLE_CRASH
	DOMAIN_LIFECYCLE_LAST                                                                   = VIR_DOMAIN_LIFECYCLE_LAST
	DOMAIN_LIFECYCLE_POWEROFF                                                               = VIR_DOMAIN_LIFECYCLE_POWEROFF
	DOMAIN_LIFECYCLE_REBOOT                                                                 = VIR_DOMAIN_LIFECYCLE_REBOOT
	DOMAIN_MEMORY_FAILURE_ACTION_REQUIRED                                                   = VIR_DOMAIN_MEMORY_FAILURE_ACTION_REQUIRED
	DOMAIN_MEMORY_FAILURE_RECURSIVE                                                         = VIR_DOMAIN_MEMORY_FAILURE_RECURSIVE
	DOMAIN_MEMORY_PARAM_BOOLEAN                                                             = VIR_DOMAIN_MEMORY_PARAM_BOOLEAN
	DOMAIN_MEMORY_PARAM_DOUBLE                                                              = VIR_DOMAIN_MEMORY_PARAM_DOUBLE
	DOMAIN_MEMORY_PARAM_INT                                                                 = VIR_DOMAIN_MEMORY_PARAM_INT
	DOMAIN_MEMORY_PARAM_LLONG                                                               = VIR_DOMAIN_MEMORY_PARAM_LLONG
	DOMAIN_MEMORY_PARAM_UINT                                                                = VIR_DOMAIN_MEMORY_PARAM_UINT
	DOMAIN_MEMORY_PARAM_ULLONG                                                              = VIR_DOMAIN_MEMORY_PARAM_ULLONG
	DOMAIN_MEMORY_STAT_ACTUAL_BALLOON                                                       = VIR_DOMAIN_MEMORY_STAT_ACTUAL_BALLOON
	DOMAIN_MEMORY_STAT_AVAILABLE                                                            = VIR_DOMAIN_MEMORY_STAT_AVAILABLE
	DOMAIN_MEMORY_STAT_DISK_CACHES                                                          = VIR_DOMAIN_MEMORY_STAT_DISK_CACHES
	DOMAIN_MEMORY_STAT_HUGETLB_PGALLOC                                                      = VIR_DOMAIN_MEMORY_STAT_HUGETLB_PGALLOC
	DOMAIN_MEMORY_STAT_HUGETLB_PGFAIL                                                       = VIR_DOMAIN_MEMORY_STAT_HUGETLB_PGFAIL
	DOMAIN_MEMORY_STAT_LAST                                                                 = VIR_DOMAIN_MEMORY_STAT_LAST
	DOMAIN_MEMORY_STAT_LAST_UPDATE                                                          = VIR_DOMAIN_MEMORY_STAT_LAST_UPDATE
	DOMAIN_MEMORY_STAT_MAJOR_FAULT                                                          = VIR_DOMAIN_MEMORY_STAT_MAJOR_FAULT
	DOMAIN_MEMORY_STAT_MINOR_FAULT                                                          = VIR_DOMAIN_MEMORY_STAT_MINOR_FAULT
	DOMAIN_MEMORY_STAT_NR                                                                   = VIR_DOMAIN_MEMORY_STAT_NR
	DOMAIN_MEMORY_STAT_RSS                                                                  = VIR_DOMAIN_MEMORY_STAT_RSS
	DOMAIN_MEMORY_STAT_SWAP_IN                                                              = VIR_DOMAIN_MEMORY_STAT_SWAP_IN
	DOMAIN_MEMORY_STAT_SWAP_OUT                                                             = VIR_DOMAIN_MEMORY_STAT_SWAP_OUT
	DOMAIN_MEMORY_STAT_UNUSED                                                               = VIR_DOMAIN_MEMORY_STAT_UNUSED
	DOMAIN_MEMORY_STAT_USABLE                                                               = VIR_DOMAIN_MEMORY_STAT_USABLE
	DOMAIN_MEM_CONFIG                                                                       = VIR_DOMAIN_MEM_CONFIG
	DOMAIN_MEM_CURRENT                                                                      = VIR_DOMAIN_MEM_CURRENT
	DOMAIN_MEM_LIVE                                                                         = VIR_DOMAIN_MEM_LIVE
	DOMAIN_MEM_MAXIMUM                                                                      = VIR_DOMAIN_MEM_MAXIMUM
	DOMAIN_MESSAGE_DEPRECATION                                                              = VIR_DOMAIN_MESSAGE_DEPRECATION
	DOMAIN_MESSAGE_IOERRORS                                                                 = VIR_DOMAIN_MESSAGE_IOERRORS
	DOMAIN_MESSAGE_TAINTING                                                                 = VIR_DOMAIN_MESSAGE_TAINTING
	DOMAIN_METADATA_DESCRIPTION                                                             = VIR_DOMAIN_METADATA_DESCRIPTION
	DOMAIN_METADATA_ELEMENT                                                                 = VIR_DOMAIN_METADATA_ELEMENT
	DOMAIN_METADATA_LAST                                                                    = VIR_DOMAIN_METADATA_LAST
	DOMAIN_METADATA_TITLE                                                                   = VIR_DOMAIN_METADATA_TITLE
	DOMAIN_MIGRATE_MAX_SPEED_POSTCOPY                                                       = VIR_DOMAIN_MIGRATE_MAX_SPEED_POSTCOPY
	DOMAIN_NONE                                                                             = VIR_DOMAIN_NONE
	DOMAIN_NOSTATE                                               DomainState                = DomainState(VIR_DOMAIN_NOSTATE)
	DOMAIN_NOSTATE_LAST                                                                     = VIR_DOMAIN_NOSTATE_LAST
	DOMAIN_NOSTATE_UNKNOWN                                                                  = VIR_DOMAIN_NOSTATE_UNKNOWN
	DOMAIN_NUMATUNE_MEM_INTERLEAVE                                                          = VIR_DOMAIN_NUMATUNE_MEM_INTERLEAVE
	DOMAIN_NUMATUNE_MEM_LAST                                                                = VIR_DOMAIN_NUMATUNE_MEM_LAST
	DOMAIN_NUMATUNE_MEM_PREFERRED                                                           = VIR_DOMAIN_NUMATUNE_MEM_PREFERRED
	DOMAIN_NUMATUNE_MEM_RESTRICTIVE                                                         = VIR_DOMAIN_NUMATUNE_MEM_RESTRICTIVE
	DOMAIN_NUMATUNE_MEM_STRICT                                                              = VIR_DOMAIN_NUMATUNE_MEM_STRICT
	DOMAIN_OPEN_GRAPHICS_SKIPAUTH                                                           = VIR_DOMAIN_OPEN_GRAPHICS_SKIPAUTH
	DOMAIN_PASSWORD_ENCRYPTED                                                               = VIR_DOMAIN_PASSWORD_ENCRYPTED
	DOMAIN_PAUSED                                                DomainState                = DomainState(VIR_DOMAIN_PAUSED)
	DOMAIN_PAUSED_API_ERROR                                                                 = VIR_DOMAIN_PAUSED_API_ERROR
	DOMAIN_PAUSED_CRASHED                                                                   = VIR_DOMAIN_PAUSED_CRASHED
	DOMAIN_PAUSED_DUMP                                                                      = VIR_DOMAIN_PAUSED_DUMP
	DOMAIN_PAUSED_FROM_SNAPSHOT                                                             = VIR_DOMAIN_PAUSED_FROM_SNAPSHOT
	DOMAIN_PAUSED_IOERROR                                                                   = VIR_DOMAIN_PAUSED_IOERROR
	DOMAIN_PAUSED_LAST                                                                      = VIR_DOMAIN_PAUSED_LAST
	DOMAIN_PAUSED_MIGRATION                                                                 = VIR_DOMAIN_PAUSED_MIGRATION
	DOMAIN_PAUSED_POSTCOPY                                                                  = VIR_DOMAIN_PAUSED_POSTCOPY
	DOMAIN_PAUSED_POSTCOPY_FAILED                                                           = VIR_DOMAIN_PAUSED_POSTCOPY_FAILED
	DOMAIN_PAUSED_SAVE                                                                      = VIR_DOMAIN_PAUSED_SAVE
	DOMAIN_PAUSED_SHUTTING_DOWN                                                             = VIR_DOMAIN_PAUSED_SHUTTING_DOWN
	DOMAIN_PAUSED_SNAPSHOT                                                                  = VIR_DOMAIN_PAUSED_SNAPSHOT
	DOMAIN_PAUSED_STARTING_UP                                                               = VIR_DOMAIN_PAUSED_STARTING_UP
	DOMAIN_PAUSED_UNKNOWN                                                                   = VIR_DOMAIN_PAUSED_UNKNOWN
	DOMAIN_PAUSED_USER                                                                      = VIR_DOMAIN_PAUSED_USER
	DOMAIN_PAUSED_WATCHDOG                                                                  = VIR_DOMAIN_PAUSED_WATCHDOG
	DOMAIN_PMSUSPENDED                                           DomainState                = DomainState(VIR_DOMAIN_PMSUSPENDED)
	DOMAIN_PMSUSPENDED_DISK_LAST                                                            = VIR_DOMAIN_PMSUSPENDED_DISK_LAST
	DOMAIN_PMSUSPENDED_DISK_UNKNOWN                                                         = VIR_DOMAIN_PMSUSPENDED_DISK_UNKNOWN
	DOMAIN_PMSUSPENDED_LAST                                                                 = VIR_DOMAIN_PMSUSPENDED_LAST
	DOMAIN_PMSUSPENDED_UNKNOWN                                                              = VIR_DOMAIN_PMSUSPENDED_UNKNOWN
	DOMAIN_PROCESS_SIGNAL_ABRT                                                              = VIR_DOMAIN_PROCESS_SIGNAL_ABRT
	DOMAIN_PROCESS_SIGNAL_ALRM                                                              = VIR_DOMAIN_PROCESS_SIGNAL_ALRM
	DOMAIN_PROCESS_SIGNAL_BUS                                                               = VIR_DOMAIN_PROCESS_SIGNAL_BUS
	DOMAIN_PROCESS_SIGNAL_CHLD                                                              = VIR_DOMAIN_PROCESS_SIGNAL_CHLD
	DOMAIN_PROCESS_SIGNAL_CONT                                                              = VIR_DOMAIN_PROCESS_SIGNAL_CONT
	DOMAIN_PROCESS_SIGNAL_FPE                                                               = VIR_DOMAIN_PROCESS_SIGNAL_FPE
	DOMAIN_PROCESS_SIGNAL_HUP                                                               = VIR_DOMAIN_PROCESS_SIGNAL_HUP
	DOMAIN_PROCESS_SIGNAL_ILL                                                               = VIR_DOMAIN_PROCESS_SIGNAL_ILL
	DOMAIN_PROCESS_SIGNAL_INT                                                               = VIR_DOMAIN_PROCESS_SIGNAL_INT
	DOMAIN_PROCESS_SIGNAL_KILL                                                              = VIR_DOMAIN_PROCESS_SIGNAL_KILL
	DOMAIN_PROCESS_SIGNAL_LAST                                                              = VIR_DOMAIN_PROCESS_SIGNAL_LAST
	DOMAIN_PROCESS_SIGNAL_NOP                                                               = VIR_DOMAIN_PROCESS_SIGNAL_NOP
	DOMAIN_PROCESS_SIGNAL_PIPE                                                              = VIR_DOMAIN_PROCESS_SIGNAL_PIPE
	DOMAIN_PROCESS_SIGNAL_POLL                                                              = VIR_DOMAIN_PROCESS_SIGNAL_POLL
	DOMAIN_PROCESS_SIGNAL_PROF                                                              = VIR_DOMAIN_PROCESS_SIGNAL_PROF
	DOMAIN_PROCESS_SIGNAL_PWR                                                               = VIR_DOMAIN_PROCESS_SIGNAL_PWR
	DOMAIN_PROCESS_SIGNAL_QUIT                                                              = VIR_DOMAIN_PROCESS_SIGNAL_QUIT
	DOMAIN_PROCESS_SIGNAL_RT0                                                               = VIR_DOMAIN_PROCESS_SIGNAL_RT0
	DOMAIN_PROCESS_SIGNAL_RT1                                                               = VIR_DOMAIN_PROCESS_SIGNAL_RT1
	DOMAIN_PROCESS_SIGNAL_RT10                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT10
	DOMAIN_PROCESS_SIGNAL_RT11                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT11
	DOMAIN_PROCESS_SIGNAL_RT12                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT12
	DOMAIN_PROCESS_SIGNAL_RT13                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT13
	DOMAIN_PROCESS_SIGNAL_RT14                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT14
	DOMAIN_PROCESS_SIGNAL_RT15                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT15
	DOMAIN_PROCESS_SIGNAL_RT16                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT16
	DOMAIN_PROCESS_SIGNAL_RT17                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT17
	DOMAIN_PROCESS_SIGNAL_RT18                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT18
	DOMAIN_PROCESS_SIGNAL_RT19                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT19
	DOMAIN_PROCESS_SIGNAL_RT2                                                               = VIR_DOMAIN_PROCESS_SIGNAL_RT2
	DOMAIN_PROCESS_SIGNAL_RT20                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT20
	DOMAIN_PROCESS_SIGNAL_RT21                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT21
	DOMAIN_PROCESS_SIGNAL_RT22                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT22
	DOMAIN_PROCESS_SIGNAL_RT23                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT23
	DOMAIN_PROCESS_SIGNAL_RT24                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT24
	DOMAIN_PROCESS_SIGNAL_RT25                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT25
	DOMAIN_PROCESS_SIGNAL_RT26                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT26
	DOMAIN_PROCESS_SIGNAL_RT27                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT27
	DOMAIN_PROCESS_SIGNAL_RT28                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT28
	DOMAIN_PROCESS_SIGNAL_RT29                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT29
	DOMAIN_PROCESS_SIGNAL_RT3                                                               = VIR_DOMAIN_PROCESS_SIGNAL_RT3
	DOMAIN_PROCESS_SIGNAL_RT30                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT30
	DOMAIN_PROCESS_SIGNAL_RT31                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT31
	DOMAIN_PROCESS_SIGNAL_RT32                                                              = VIR_DOMAIN_PROCESS_SIGNAL_RT32
	DOMAIN_PROCESS_SIGNAL_RT4                                                               = VIR_DOMAIN_PROCESS_SIGNAL_RT4
	DOMAIN_PROCESS_SIGNAL_RT5                                                               = VIR_DOMAIN_PROCESS_SIGNAL_RT5
	DOMAIN_PROCESS_SIGNAL_RT6                                                               = VIR_DOMAIN_PROCESS_SIGNAL_RT6
	DOMAIN_PROCESS_SIGNAL_RT7                                                               = VIR_DOMAIN_PROCESS_SIGNAL_RT7
	DOMAIN_PROCESS_SIGNAL_RT8                                                               = VIR_DOMAIN_PROCESS_SIGNAL_RT8
	DOMAIN_PROCESS_SIGNAL_RT9                                                               = VIR_DOMAIN_PROCESS_SIGNAL_RT9
	DOMAIN_PROCESS_SIGNAL_SEGV                                                              = VIR_DOMAIN_PROCESS_SIGNAL_SEGV
	DOMAIN_PROCESS_SIGNAL_STKFLT                                                            = VIR_DOMAIN_PROCESS_SIGNAL_STKFLT
	DOMAIN_PROCESS_SIGNAL_STOP                                                              = VIR_DOMAIN_PROCESS_SIGNAL_STOP
	DOMAIN_PROCESS_SIGNAL_SYS                                                               = VIR_DOMAIN_PROCESS_SIGNAL_SYS
	DOMAIN_PROCESS_SIGNAL_TERM                                                              = VIR_DOMAIN_PROCESS_SIGNAL_TERM
	DOMAIN_PROCESS_SIGNAL_TRAP                                                              = VIR_DOMAIN_PROCESS_SIGNAL_TRAP
	DOMAIN_PROCESS_SIGNAL_TSTP                                                              = VIR_DOMAIN_PROCESS_SIGNAL_TSTP
	DOMAIN_PROCESS_SIGNAL_TTIN                                                              = VIR_DOMAIN_PROCESS_SIGNAL_TTIN
	DOMAIN_PROCESS_SIGNAL_TTOU                                                              = VIR_DOMAIN_PROCESS_SIGNAL_TTOU
	DOMAIN_PROCESS_SIGNAL_URG                                                               = VIR_DOMAIN_PROCESS_SIGNAL_URG
	DOMAIN_PROCESS_SIGNAL_USR1                                                              = VIR_DOMAIN_PROCESS_SIGNAL_USR1
	DOMAIN_PROCESS_SIGNAL_USR2                                                              = VIR_DOMAIN_PROCESS_SIGNAL_USR2
	DOMAIN_PROCESS_SIGNAL_VTALRM                                                            = VIR_DOMAIN_PROCESS_SIGNAL_VTALRM
	DOMAIN_PROCESS_SIGNAL_WINCH                                                             = VIR_DOMAIN_PROCESS_SIGNAL_WINCH
	DOMAIN_PROCESS_SIGNAL_XCPU                                                              = VIR_DOMAIN_PROCESS_SIGNAL_XCPU
	DOMAIN_PROCESS_SIGNAL_XFSZ                                                              = VIR_DOMAIN_PROCESS_SIGNAL_XFSZ
	DOMAIN_QEMU_AGENT_COMMAND_BLOCK                                                         = VIR_DOMAIN_QEMU_AGENT_COMMAND_BLOCK
	DOMAIN_QEMU_AGENT_COMMAND_DEFAULT                                                       = VIR_DOMAIN_QEMU_AGENT_COMMAND_DEFAULT
	DOMAIN_QEMU_AGENT_COMMAND_MIN                                                           = VIR_DOMAIN_QEMU_AGENT_COMMAND_MIN
	DOMAIN_QEMU_AGENT_COMMAND_NOWAIT                                                        = VIR_DOMAIN_QEMU_AGENT_COMMAND_NOWAIT
	DOMAIN_QEMU_AGENT_COMMAND_SHUTDOWN                                                      = VIR_DOMAIN_QEMU_AGENT_COMMAND_SHUTDOWN
	DOMAIN_QEMU_MONITOR_COMMAND_DEFAULT                                                     = VIR_DOMAIN_QEMU_MONITOR_COMMAND_DEFAULT
	DOMAIN_QEMU_MONITOR_COMMAND_HMP                                                         = VIR_DOMAIN_QEMU_MONITOR_COMMAND_HMP
	DOMAIN_REBOOT_ACPI_POWER_BTN                                                            = VIR_DOMAIN_REBOOT_ACPI_POWER_BTN
	DOMAIN_REBOOT_DEFAULT                                                                   = VIR_DOMAIN_REBOOT_DEFAULT
	DOMAIN_REBOOT_GUEST_AGENT                                                               = VIR_DOMAIN_REBOOT_GUEST_AGENT
	DOMAIN_REBOOT_INITCTL                                                                   = VIR_DOMAIN_REBOOT_INITCTL
	DOMAIN_REBOOT_PARAVIRT                                                                  = VIR_DOMAIN_REBOOT_PARAVIRT
	DOMAIN_REBOOT_SIGNAL                                                                    = VIR_DOMAIN_REBOOT_SIGNAL
	DOMAIN_RUNNING                                               DomainState                = DomainState(VIR_DOMAIN_RUNNING)
	DOMAIN_RUNNING_BOOTED                                                                   = VIR_DOMAIN_RUNNING_BOOTED
	DOMAIN_RUNNING_CRASHED                                                                  = VIR_DOMAIN_RUNNING_CRASHED
	DOMAIN_RUNNING_FROM_SNAPSHOT                                                            = VIR_DOMAIN_RUNNING_FROM_SNAPSHOT
	DOMAIN_RUNNING_LAST                                                                     = VIR_DOMAIN_RUNNING_LAST
	DOMAIN_RUNNING_MIGRATED                                                                 = VIR_DOMAIN_RUNNING_MIGRATED
	DOMAIN_RUNNING_MIGRATION_CANCELED                                                       = VIR_DOMAIN_RUNNING_MIGRATION_CANCELED
	DOMAIN_RUNNING_POSTCOPY                                                                 = VIR_DOMAIN_RUNNING_POSTCOPY
	DOMAIN_RUNNING_POSTCOPY_FAILED                                                          = VIR_DOMAIN_RUNNING_POSTCOPY_FAILED
	DOMAIN_RUNNING_RESTORED                                                                 = VIR_DOMAIN_RUNNING_RESTORED
	DOMAIN_RUNNING_SAVE_CANCELED                                                            = VIR_DOMAIN_RUNNING_SAVE_CANCELED
	DOMAIN_RUNNING_UNKNOWN                                                                  = VIR_DOMAIN_RUNNING_UNKNOWN
	DOMAIN_RUNNING_UNPAUSED                                                                 = VIR_DOMAIN_RUNNING_UNPAUSED
	DOMAIN_RUNNING_WAKEUP                                                                   = VIR_DOMAIN_RUNNING_WAKEUP
	DOMAIN_SAVE_BYPASS_CACHE                                                                = VIR_DOMAIN_SAVE_BYPASS_CACHE
	DOMAIN_SAVE_IMAGE_XML_SECURE                                                            = VIR_DOMAIN_SAVE_IMAGE_XML_SECURE
	DOMAIN_SAVE_PAUSED                                                                      = VIR_DOMAIN_SAVE_PAUSED
	DOMAIN_SAVE_RESET_NVRAM                                                                 = VIR_DOMAIN_SAVE_RESET_NVRAM
	DOMAIN_SAVE_RUNNING                                                                     = VIR_DOMAIN_SAVE_RUNNING
	DOMAIN_SCHED_FIELD_BOOLEAN                                                              = VIR_DOMAIN_SCHED_FIELD_BOOLEAN
	DOMAIN_SCHED_FIELD_DOUBLE                                                               = VIR_DOMAIN_SCHED_FIELD_DOUBLE
	DOMAIN_SCHED_FIELD_INT                                                                  = VIR_DOMAIN_SCHED_FIELD_INT
	DOMAIN_SCHED_FIELD_LLONG                                                                = VIR_DOMAIN_SCHED_FIELD_LLONG
	DOMAIN_SCHED_FIELD_UINT                                                                 = VIR_DOMAIN_SCHED_FIELD_UINT
	DOMAIN_SCHED_FIELD_ULLONG                                                               = VIR_DOMAIN_SCHED_FIELD_ULLONG
	DOMAIN_SETVCPU_AFFECT_CONFIG                                                            = VIR_DOMAIN_SETVCPU_AFFECT_CONFIG
	DOMAIN_SETVCPU_AFFECT_CURRENT                                                           = VIR_DOMAIN_SETVCPU_AFFECT_CURRENT
	DOMAIN_SETVCPU_AFFECT_LIVE                                                              = VIR_DOMAIN_SETVCPU_AFFECT_LIVE
	DOMAIN_SETVCPU_ASYNC_UNPLUG                                                             = VIR_DOMAIN_SETVCPU_ASYNC_UNPLUG
	DOMAIN_SHUTDOWN                                              DomainState                = DomainState(VIR_DOMAIN_SHUTDOWN)
	DOMAIN_SHUTDOWN_ACPI_POWER_BTN                                                          = VIR_DOMAIN_SHUTDOWN_ACPI_POWER_BTN
	DOMAIN_SHUTDOWN_DEFAULT                                                                 = VIR_DOMAIN_SHUTDOWN_DEFAULT
	DOMAIN_SHUTDOWN_GUEST_AGENT                                                             = VIR_DOMAIN_SHUTDOWN_GUEST_AGENT
	DOMAIN_SHUTDOWN_INITCTL                                                                 = VIR_DOMAIN_SHUTDOWN_INITCTL
	DOMAIN_SHUTDOWN_LAST                                                                    = VIR_DOMAIN_SHUTDOWN_LAST
	DOMAIN_SHUTDOWN_PARAVIRT                                                                = VIR_DOMAIN_SHUTDOWN_PARAVIRT
	DOMAIN_SHUTDOWN_SIGNAL                                                                  = VIR_DOMAIN_SHUTDOWN_SIGNAL
	DOMAIN_SHUTDOWN_UNKNOWN                                                                 = VIR_DOMAIN_SHUTDOWN_UNKNOWN
	DOMAIN_SHUTDOWN_USER                                                                    = VIR_DOMAIN_SHUTDOWN_USER
	DOMAIN_SHUTOFF                                               DomainState                = DomainState(VIR_DOMAIN_SHUTOFF)
	DOMAIN_SHUTOFF_CRASHED                                                                  = VIR_DOMAIN_SHUTOFF_CRASHED
	DOMAIN_SHUTOFF_DAEMON                                                                   = VIR_DOMAIN_SHUTOFF_DAEMON
	DOMAIN_SHUTOFF_DESTROYED                                                                = VIR_DOMAIN_SHUTOFF_DESTROYED
	DOMAIN_SHUTOFF_FAILED                                                                   = VIR_DOMAIN_SHUTOFF_FAILED
	DOMAIN_SHUTOFF_FROM_SNAPSHOT                                                            = VIR_DOMAIN_SHUTOFF_FROM_SNAPSHOT
	DOMAIN_SHUTOFF_LAST                                                                     = VIR_DOMAIN_SHUTOFF_LAST
	DOMAIN_SHUTOFF_MIGRATED                                                                 = VIR_DOMAIN_SHUTOFF_MIGRATED
	DOMAIN_SHUTOFF_SAVED                                                                    = VIR_DOMAIN_SHUTOFF_SAVED
	DOMAIN_SHUTOFF_SHUTDOWN                                                                 = VIR_DOMAIN_SHUTOFF_SHUTDOWN
	DOMAIN_SHUTOFF_UNKNOWN                                                                  = VIR_DOMAIN_SHUTOFF_UNKNOWN
	DOMAIN_SNAPSHOT_CREATE_ATOMIC                                DomainSnapshotCreateFlags  = DomainSnapshotCreateFlags(VIR_DOMAIN_SNAPSHOT_CREATE_ATOMIC)
	DOMAIN_SNAPSHOT_CREATE_CURRENT                               DomainSnapshotCreateFlags  = DomainSnapshotCreateFlags(VIR_DOMAIN_SNAPSHOT_CREATE_CURRENT)
	DOMAIN_SNAPSHOT_CREATE_DISK_ONLY                             DomainSnapshotCreateFlags  = DomainSnapshotCreateFlags(VIR_DOMAIN_SNAPSHOT_CREATE_DISK_ONLY)
	DOMAIN_SNAPSHOT_CREATE_HALT                                  DomainSnapshotCreateFlags  = DomainSnapshotCreateFlags(VIR_DOMAIN_SNAPSHOT_CREATE_HALT)
	DOMAIN_SNAPSHOT_CREATE_LIVE                                  DomainSnapshotCreateFlags  = DomainSnapshotCreateFlags(VIR_DOMAIN_SNAPSHOT_CREATE_LIVE)
	DOMAIN_SNAPSHOT_CREATE_NO_METADATA                           DomainSnapshotCreateFlags  = DomainSnapshotCreateFlags(VIR_DOMAIN_SNAPSHOT_CREATE_NO_METADATA)
	DOMAIN_SNAPSHOT_CREATE_QUIESCE                               DomainSnapshotCreateFlags  = DomainSnapshotCreateFlags(VIR_DOMAIN_SNAPSHOT_CREATE_QUIESCE)
	DOMAIN_SNAPSHOT_CREATE_REDEFINE                              DomainSnapshotCreateFlags  = DomainSnapshotCreateFlags(VIR_DOMAIN_SNAPSHOT_CREATE_REDEFINE)
	DOMAIN_SNAPSHOT_CREATE_REUSE_EXT                             DomainSnapshotCreateFlags  = DomainSnapshotCreateFlags(VIR_DOMAIN_SNAPSHOT_CREATE_REUSE_EXT)
	DOMAIN_SNAPSHOT_CREATE_VALIDATE                              DomainSnapshotCreateFlags  = DomainSnapshotCreateFlags(VIR_DOMAIN_SNAPSHOT_CREATE_VALIDATE)
	DOMAIN_SNAPSHOT_DELETE_CHILDREN                                                         = VIR_DOMAIN_SNAPSHOT_DELETE_CHILDREN
	DOMAIN_SNAPSHOT_DELETE_CHILDREN_ONLY                                                    = VIR_DOMAIN_SNAPSHOT_DELETE_CHILDREN_ONLY
	DOMAIN_SNAPSHOT_DELETE_METADATA_ONLY                                                    = VIR_DOMAIN_SNAPSHOT_DELETE_METADATA_ONLY
	DOMAIN_SNAPSHOT_LIST_ACTIVE                                                             = VIR_DOMAIN_SNAPSHOT_LIST_ACTIVE
	DOMAIN_SNAPSHOT_LIST_DESCENDANTS                                                        = VIR_DOMAIN_SNAPSHOT_LIST_DESCENDANTS
	DOMAIN_SNAPSHOT_LIST_DISK_ONLY                                                          = VIR_DOMAIN_SNAPSHOT_LIST_DISK_ONLY
	DOMAIN_SNAPSHOT_LIST_EXTERNAL                                                           = VIR_DOMAIN_SNAPSHOT_LIST_EXTERNAL
	DOMAIN_SNAPSHOT_LIST_INACTIVE                                                           = VIR_DOMAIN_SNAPSHOT_LIST_INACTIVE
	DOMAIN_SNAPSHOT_LIST_INTERNAL                                                           = VIR_DOMAIN_SNAPSHOT_LIST_INTERNAL
	DOMAIN_SNAPSHOT_LIST_LEAVES                                                             = VIR_DOMAIN_SNAPSHOT_LIST_LEAVES
	DOMAIN_SNAPSHOT_LIST_METADATA                                                           = VIR_DOMAIN_SNAPSHOT_LIST_METADATA
	DOMAIN_SNAPSHOT_LIST_NO_LEAVES                                                          = VIR_DOMAIN_SNAPSHOT_LIST_NO_LEAVES
	DOMAIN_SNAPSHOT_LIST_NO_METADATA                                                        = VIR_DOMAIN_SNAPSHOT_LIST_NO_METADATA
	DOMAIN_SNAPSHOT_LIST_ROOTS                                                              = VIR_DOMAIN_SNAPSHOT_LIST_ROOTS
	DOMAIN_SNAPSHOT_LIST_TOPOLOGICAL                                                        = VIR_DOMAIN_SNAPSHOT_LIST_TOPOLOGICAL
	DOMAIN_SNAPSHOT_REVERT_FORCE                                 DomainSnapshotRevertFlags  = DomainSnapshotRevertFlags(VIR_DOMAIN_SNAPSHOT_REVERT_FORCE)
	DOMAIN_SNAPSHOT_REVERT_PAUSED                                DomainSnapshotRevertFlags  = DomainSnapshotRevertFlags(VIR_DOMAIN_SNAPSHOT_REVERT_PAUSED)
	DOMAIN_SNAPSHOT_REVERT_RESET_NVRAM                           DomainSnapshotRevertFlags  = DomainSnapshotRevertFlags(VIR_DOMAIN_SNAPSHOT_REVERT_RESET_NVRAM)
	DOMAIN_SNAPSHOT_REVERT_RUNNING                               DomainSnapshotRevertFlags  = DomainSnapshotRevertFlags(VIR_DOMAIN_SNAPSHOT_REVERT_RUNNING)
	DOMAIN_SNAPSHOT_XML_SECURE                                                              = VIR_DOMAIN_SNAPSHOT_XML_SECURE
	DOMAIN_START_AUTODESTROY                                                                = VIR_DOMAIN_START_AUTODESTROY
	DOMAIN_START_BYPASS_CACHE                                                               = VIR_DOMAIN_START_BYPASS_CACHE
	DOMAIN_START_FORCE_BOOT                                                                 = VIR_DOMAIN_START_FORCE_BOOT
	DOMAIN_START_PAUSED                                                                     = VIR_DOMAIN_START_PAUSED
	DOMAIN_START_RESET_NVRAM                                                                = VIR_DOMAIN_START_RESET_NVRAM
	DOMAIN_START_VALIDATE                                                                   = VIR_DOMAIN_START_VALIDATE
	DOMAIN_STATS_BALLOON                                                                    = VIR_DOMAIN_STATS_BALLOON
	DOMAIN_STATS_BLOCK                                                                      = VIR_DOMAIN_STATS_BLOCK
	DOMAIN_STATS_CPU_TOTAL                                                                  = VIR_DOMAIN_STATS_CPU_TOTAL
	DOMAIN_STATS_DIRTYRATE                                                                  = VIR_DOMAIN_STATS_DIRTYRATE
	DOMAIN_STATS_INTERFACE                                                                  = VIR_DOMAIN_STATS_INTERFACE
	DOMAIN_STATS_IOTHREAD                                                                   = VIR_DOMAIN_STATS_IOTHREAD
	DOMAIN_STATS_MEMORY                                                                     = VIR_DOMAIN_STATS_MEMORY
	DOMAIN_STATS_PERF                                                                       = VIR_DOMAIN_STATS_PERF
	DOMAIN_STATS_STATE                                                                      = VIR_DOMAIN_STATS_STATE
	DOMAIN_STATS_VCPU                                                                       = VIR_DOMAIN_STATS_VCPU
	DOMAIN_STATS_VM                                                                         = VIR_DOMAIN_STATS_VM
	DOMAIN_TIME_SYNC                                                                        = VIR_DOMAIN_TIME_SYNC
	DOMAIN_UNDEFINE_CHECKPOINTS_METADATA                         DomainUndefineFlagsValues  = DomainUndefineFlagsValues(VIR_DOMAIN_UNDEFINE_CHECKPOINTS_METADATA)
	DOMAIN_UNDEFINE_KEEP_NVRAM                                   DomainUndefineFlagsValues  = DomainUndefineFlagsValues(VIR_DOMAIN_UNDEFINE_KEEP_NVRAM)
	DOMAIN_UNDEFINE_KEEP_TPM                                     DomainUndefineFlagsValues  = DomainUndefineFlagsValues(VIR_DOMAIN_UNDEFINE_KEEP_TPM)
	DOMAIN_UNDEFINE_MANAGED_SAVE                                 DomainUndefineFlagsValues  = DomainUndefineFlagsValues(VIR_DOMAIN_UNDEFINE_MANAGED_SAVE)
	DOMAIN_UNDEFINE_NVRAM                                        DomainUndefineFlagsValues  = DomainUndefineFlagsValues(VIR_DOMAIN_UNDEFINE_NVRAM)
	DOMAIN_UNDEFINE_SNAPSHOTS_METADATA                           DomainUndefineFlagsValues  = DomainUndefineFlagsValues(VIR_DOMAIN_UNDEFINE_SNAPSHOTS_METADATA)
	DOMAIN_UNDEFINE_TPM                                          DomainUndefineFlagsValues  = DomainUndefineFlagsValues(VIR_DOMAIN_UNDEFINE_TPM)
	DOMAIN_VCPU_ASYNC_UNPLUG                                                                = VIR_DOMAIN_VCPU_ASYNC_UNPLUG
	DOMAIN_VCPU_CONFIG                                                                      = VIR_DOMAIN_VCPU_CONFIG
	DOMAIN_VCPU_CURRENT                                                                     = VIR_DOMAIN_VCPU_CURRENT
	DOMAIN_VCPU_GUEST                                                                       = VIR_DOMAIN_VCPU_GUEST
	DOMAIN_VCPU_HOTPLUGGABLE                                                                = VIR_DOMAIN_VCPU_HOTPLUGGABLE
	DOMAIN_VCPU_LIVE                                                                        = VIR_DOMAIN_VCPU_LIVE
	DOMAIN_VCPU_MAXIMUM                                                                     = VIR_DOMAIN_VCPU_MAXIMUM
	DOMAIN_XML_INACTIVE                                          DomainXMLFlags             = DomainXMLFlags(VIR_DOMAIN_XML_INACTIVE)
	DOMAIN_XML_MIGRATABLE                                        DomainXMLFlags             = DomainXMLFlags(VIR_DOMAIN_XML_MIGRATABLE)
	DOMAIN_XML_SECURE                                            DomainXMLFlags             = DomainXMLFlags(VIR_DOMAIN_XML_SECURE)
	DOMAIN_XML_UPDATE_CPU                                        DomainXMLFlags             = DomainXMLFlags(VIR_DOMAIN_XML_UPDATE_CPU)
	DUMP_BYPASS_CACHE                                                                       = VIR_DUMP_BYPASS_CACHE
	DUMP_CRASH                                                                              = VIR_DUMP_CRASH
	DUMP_LIVE                                                                               = VIR_DUMP_LIVE
	DUMP_MEMORY_ONLY                                                                        = VIR_DUMP_MEMORY_ONLY
	DUMP_RESET                                                                              = VIR_DUMP_RESET
	ERR_ACCESS_DENIED                                            ErrorNumber                = ErrorNumber(VIR_ERR_ACCESS_DENIED)
	ERR_AGENT_COMMAND_FAILED                                     ErrorNumber                = ErrorNumber(VIR_ERR_AGENT_COMMAND_FAILED)
	ERR_AGENT_COMMAND_TIMEOUT                                    ErrorNumber                = ErrorNumber(VIR_ERR_AGENT_COMMAND_TIMEOUT)
	ERR_AGENT_UNRESPONSIVE                                       ErrorNumber                = ErrorNumber(VIR_ERR_AGENT_UNRESPONSIVE)
	ERR_AGENT_UNSYNCED                                           ErrorNumber                = ErrorNumber(VIR_ERR_AGENT_UNSYNCED)
	ERR_ARGUMENT_UNSUPPORTED                                     ErrorNumber                = ErrorNumber(VIR_ERR_ARGUMENT_UNSUPPORTED)
	ERR_AUTH_CANCELLED                                           ErrorNumber                = ErrorNumber(VIR_ERR_AUTH_CANCELLED)
	ERR_AUTH_FAILED                                              ErrorNumber                = ErrorNumber(VIR_ERR_AUTH_FAILED)
	ERR_AUTH_UNAVAILABLE                                         ErrorNumber                = ErrorNumber(VIR_ERR_AUTH_UNAVAILABLE)
	ERR_BLOCK_COPY_ACTIVE                                        ErrorNumber                = ErrorNumber(VIR_ERR_BLOCK_COPY_ACTIVE)
	ERR_BUILD_FIREWALL                                           ErrorNumber                = ErrorNumber(VIR_ERR_BUILD_FIREWALL)
	ERR_CALL_FAILED                                              ErrorNumber                = ErrorNumber(VIR_ERR_CALL_FAILED)
	ERR_CHECKPOINT_INCONSISTENT                                  ErrorNumber                = ErrorNumber(VIR_ERR_CHECKPOINT_INCONSISTENT)
	ERR_CONFIG_UNSUPPORTED                                       ErrorNumber                = ErrorNumber(VIR_ERR_CONFIG_UNSUPPORTED)
	ERR_CONF_SYNTAX                                              ErrorNumber                = ErrorNumber(VIR_ERR_CONF_SYNTAX)
	ERR_CPU_INCOMPATIBLE                                         ErrorNumber                = ErrorNumber(VIR_ERR_CPU_INCOMPATIBLE)
	ERR_DBUS_SERVICE                                             ErrorNumber                = ErrorNumber(VIR_ERR_DBUS_SERVICE)
	ERR_DEVICE_MISSING                                           ErrorNumber                = ErrorNumber(VIR_ERR_DEVICE_MISSING)
	ERR_DOMAIN_LAST                                              ErrorDomain                = ErrorDomain(VIR_ERR_DOMAIN_LAST)
	ERR_DOM_EXIST                                                ErrorNumber                = ErrorNumber(VIR_ERR_DOM_EXIST)
	ERR_DRIVER_FULL                                              ErrorNumber                = ErrorNumber(VIR_ERR_DRIVER_FULL)
	ERR_ERROR                                                    ErrorLevel                 = ErrorLevel(VIR_ERR_ERROR)
	ERR_GET_FAILED                                               ErrorNumber                = ErrorNumber(VIR_ERR_GET_FAILED)
	ERR_GNUTLS_ERROR                                             ErrorNumber                = ErrorNumber(VIR_ERR_GNUTLS_ERROR)
	ERR_HOOK_SCRIPT_FAILED                                       ErrorNumber                = ErrorNumber(VIR_ERR_HOOK_SCRIPT_FAILED)
	ERR_HTTP_ERROR                                               ErrorNumber                = ErrorNumber(VIR_ERR_HTTP_ERROR)
	ERR_INTERNAL_ERROR                                           ErrorNumber                = ErrorNumber(VIR_ERR_INTERNAL_ERROR)
	ERR_INVALID_ARG                                              ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_ARG)
	ERR_INVALID_CONN                                             ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_CONN)
	ERR_INVALID_DOMAIN                                           ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_DOMAIN)
	ERR_INVALID_DOMAIN_CHECKPOINT                                ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_DOMAIN_CHECKPOINT)
	ERR_INVALID_DOMAIN_SNAPSHOT                                  ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_DOMAIN_SNAPSHOT)
	ERR_INVALID_ENCR_KEY_SECRET                                  ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_ENCR_KEY_SECRET)
	ERR_INVALID_INTERFACE                                        ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_INTERFACE)
	ERR_INVALID_MAC                                              ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_MAC)
	ERR_INVALID_NETWORK                                          ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_NETWORK)
	ERR_INVALID_NETWORK_PORT                                     ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_NETWORK_PORT)
	ERR_INVALID_NODE_DEVICE                                      ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_NODE_DEVICE)
	ERR_INVALID_NWFILTER                                         ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_NWFILTER)
	ERR_INVALID_NWFILTER_BINDING                                 ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_NWFILTER_BINDING)
	ERR_INVALID_SECRET                                           ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_SECRET)
	ERR_INVALID_STORAGE_POOL                                     ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_STORAGE_POOL)
	ERR_INVALID_STORAGE_VOL                                      ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_STORAGE_VOL)
	ERR_INVALID_STREAM                                           ErrorNumber                = ErrorNumber(VIR_ERR_INVALID_STREAM)
	ERR_LIBSSH                                                   ErrorNumber                = ErrorNumber(VIR_ERR_LIBSSH)
	ERR_MIGRATE_FINISH_OK                                        ErrorNumber                = ErrorNumber(VIR_ERR_MIGRATE_FINISH_OK)
	ERR_MIGRATE_PERSIST_FAILED                                   ErrorNumber                = ErrorNumber(VIR_ERR_MIGRATE_PERSIST_FAILED)
	ERR_MIGRATE_UNSAFE                                           ErrorNumber                = ErrorNumber(VIR_ERR_MIGRATE_UNSAFE)
	ERR_MULTIPLE_DOMAINS                                         ErrorNumber                = ErrorNumber(VIR_ERR_MULTIPLE_DOMAINS)
	ERR_MULTIPLE_INTERFACES                                      ErrorNumber                = ErrorNumber(VIR_ERR_MULTIPLE_INTERFACES)
	ERR_NETWORK_EXIST                                            ErrorNumber                = ErrorNumber(VIR_ERR_NETWORK_EXIST)
	ERR_NETWORK_PORT_EXIST                                       ErrorNumber                = ErrorNumber(VIR_ERR_NETWORK_PORT_EXIST)
	ERR_NONE                                                     ErrorLevel                 = ErrorLevel(VIR_ERR_NONE)
	ERR_NO_CLIENT                                                ErrorNumber                = ErrorNumber(VIR_ERR_NO_CLIENT)
	ERR_NO_CONNECT                                               ErrorNumber                = ErrorNumber(VIR_ERR_NO_CONNECT)
	ERR_NO_DEVICE                                                ErrorNumber                = ErrorNumber(VIR_ERR_NO_DEVICE)
	ERR_NO_DOMAIN                                                ErrorNumber                = ErrorNumber(VIR_ERR_NO_DOMAIN)
	ERR_NO_DOMAIN_BACKUP                                         ErrorNumber                = ErrorNumber(VIR_ERR_NO_DOMAIN_BACKUP)
	ERR_NO_DOMAIN_CHECKPOINT                                     ErrorNumber                = ErrorNumber(VIR_ERR_NO_DOMAIN_CHECKPOINT)
	ERR_NO_DOMAIN_METADATA                                       ErrorNumber                = ErrorNumber(VIR_ERR_NO_DOMAIN_METADATA)
	ERR_NO_DOMAIN_SNAPSHOT                                       ErrorNumber                = ErrorNumber(VIR_ERR_NO_DOMAIN_SNAPSHOT)
	ERR_NO_HOSTNAME                                              ErrorNumber                = ErrorNumber(VIR_ERR_NO_HOSTNAME)
	ERR_NO_INTERFACE                                             ErrorNumber                = ErrorNumber(VIR_ERR_NO_INTERFACE)
	ERR_NO_KERNEL                                                ErrorNumber                = ErrorNumber(VIR_ERR_NO_KERNEL)
	ERR_NO_MEMORY                                                ErrorNumber                = ErrorNumber(VIR_ERR_NO_MEMORY)
	ERR_NO_NAME                                                  ErrorNumber                = ErrorNumber(VIR_ERR_NO_NAME)
	ERR_NO_NETWORK                                               ErrorNumber                = ErrorNumber(VIR_ERR_NO_NETWORK)
	ERR_NO_NETWORK_METADATA                                      ErrorNumber                = ErrorNumber(VIR_ERR_NO_NETWORK_METADATA)
	ERR_NO_NETWORK_PORT                                          ErrorNumber                = ErrorNumber(VIR_ERR_NO_NETWORK_PORT)
	ERR_NO_NODE_DEVICE                                           ErrorNumber                = ErrorNumber(VIR_ERR_NO_NODE_DEVICE)
	ERR_NO_NWFILTER                                              ErrorNumber                = ErrorNumber(VIR_ERR_NO_NWFILTER)
	ERR_NO_NWFILTER_BINDING                                      ErrorNumber                = ErrorNumber(VIR_ERR_NO_NWFILTER_BINDING)
	ERR_NO_OS                                                    ErrorNumber                = ErrorNumber(VIR_ERR_NO_OS)
	ERR_NO_ROOT                                                  ErrorNumber                = ErrorNumber(VIR_ERR_NO_ROOT)
	ERR_NO_SECRET                                                ErrorNumber                = ErrorNumber(VIR_ERR_NO_SECRET)
	ERR_NO_SECURITY_MODEL                                        ErrorNumber                = ErrorNumber(VIR_ERR_NO_SECURITY_MODEL)
	ERR_NO_SERVER                                                ErrorNumber                = ErrorNumber(VIR_ERR_NO_SERVER)
	ERR_NO_SOURCE                                                ErrorNumber                = ErrorNumber(VIR_ERR_NO_SOURCE)
	ERR_NO_STORAGE_POOL                                          ErrorNumber                = ErrorNumber(VIR_ERR_NO_STORAGE_POOL)
	ERR_NO_STORAGE_VOL                                           ErrorNumber                = ErrorNumber(VIR_ERR_NO_STORAGE_VOL)
	ERR_NO_SUPPORT                                               ErrorNumber                = ErrorNumber(VIR_ERR_NO_SUPPORT)
	ERR_NO_TARGET                                                ErrorNumber                = ErrorNumber(VIR_ERR_NO_TARGET)
	ERR_NO_XEN                                                   ErrorNumber                = ErrorNumber(VIR_ERR_NO_XEN)
	ERR_NO_XENSTORE                                              ErrorNumber                = ErrorNumber(VIR_ERR_NO_XENSTORE)
	ERR_NUMBER_LAST                                              ErrorNumber                = ErrorNumber(VIR_ERR_NUMBER_LAST)
	ERR_OK                                                       ErrorNumber                = ErrorNumber(VIR_ERR_OK)
	ERR_OPEN_FAILED                                              ErrorNumber                = ErrorNumber(VIR_ERR_OPEN_FAILED)
	ERR_OPERATION_ABORTED                                        ErrorNumber                = ErrorNumber(VIR_ERR_OPERATION_ABORTED)
	ERR_OPERATION_DENIED                                         ErrorNumber                = ErrorNumber(VIR_ERR_OPERATION_DENIED)
	ERR_OPERATION_FAILED                                         ErrorNumber                = ErrorNumber(VIR_ERR_OPERATION_FAILED)
	ERR_OPERATION_INVALID                                        ErrorNumber                = ErrorNumber(VIR_ERR_OPERATION_INVALID)
	ERR_OPERATION_TIMEOUT                                        ErrorNumber                = ErrorNumber(VIR_ERR_OPERATION_TIMEOUT)
	ERR_OPERATION_UNSUPPORTED                                    ErrorNumber                = ErrorNumber(VIR_ERR_OPERATION_UNSUPPORTED)
	ERR_OS_TYPE                                                  ErrorNumber                = ErrorNumber(VIR_ERR_OS_TYPE)
	ERR_OVERFLOW                                                 ErrorNumber                = ErrorNumber(VIR_ERR_OVERFLOW)
	ERR_PARSE_FAILED                                             ErrorNumber                = ErrorNumber(VIR_ERR_PARSE_FAILED)
	ERR_POST_FAILED                                              ErrorNumber                = ErrorNumber(VIR_ERR_POST_FAILED)
	ERR_READ_FAILED                                              ErrorNumber                = ErrorNumber(VIR_ERR_READ_FAILED)
	ERR_RESOURCE_BUSY                                            ErrorNumber                = ErrorNumber(VIR_ERR_RESOURCE_BUSY)
	ERR_RPC                                                      ErrorNumber                = ErrorNumber(VIR_ERR_RPC)
	ERR_SEXPR_SERIAL                                             ErrorNumber                = ErrorNumber(VIR_ERR_SEXPR_SERIAL)
	ERR_SNAPSHOT_REVERT_RISKY                                    ErrorNumber                = ErrorNumber(VIR_ERR_SNAPSHOT_REVERT_RISKY)
	ERR_SSH                                                      ErrorNumber                = ErrorNumber(VIR_ERR_SSH)
	ERR_STORAGE_POOL_BUILT                                       ErrorNumber                = ErrorNumber(VIR_ERR_STORAGE_POOL_BUILT)
	ERR_STORAGE_PROBE_FAILED                                     ErrorNumber                = ErrorNumber(VIR_ERR_STORAGE_PROBE_FAILED)
	ERR_STORAGE_VOL_EXIST                                        ErrorNumber                = ErrorNumber(VIR_ERR_STORAGE_VOL_EXIST)
	ERR_SYSTEM_ERROR                                             ErrorNumber                = ErrorNumber(VIR_ERR_SYSTEM_ERROR)
	ERR_UNKNOWN_HOST                                             ErrorNumber                = ErrorNumber(VIR_ERR_UNKNOWN_HOST)
	ERR_WARNING                                                  ErrorLevel                 = ErrorLevel(VIR_ERR_WARNING)
	ERR_WRITE_FAILED                                             ErrorNumber                = ErrorNumber(VIR_ERR_WRITE_FAILED)
	ERR_XEN_CALL                                                 ErrorNumber                = ErrorNumber(VIR_ERR_XEN_CALL)
	ERR_XML_DETAIL                                               ErrorNumber                = ErrorNumber(VIR_ERR_XML_DETAIL)
	ERR_XML_ERROR                                                ErrorNumber                = ErrorNumber(VIR_ERR_XML_ERROR)
	ERR_XML_INVALID_SCHEMA                                       ErrorNumber                = ErrorNumber(VIR_ERR_XML_INVALID_SCHEMA)
	EVENT_HANDLE_ERROR                                                                      = VIR_EVENT_HANDLE_ERROR
	EVENT_HANDLE_HANGUP                                                                     = VIR_EVENT_HANDLE_HANGUP
	EVENT_HANDLE_READABLE                                                                   = VIR_EVENT_HANDLE_READABLE
	EVENT_HANDLE_WRITABLE                                                                   = VIR_EVENT_HANDLE_WRITABLE
	FROM_ACCESS                                                  ErrorDomain                = ErrorDomain(VIR_FROM_ACCESS)
	FROM_ADMIN                                                   ErrorDomain                = ErrorDomain(VIR_FROM_ADMIN)
	FROM_AUDIT                                                   ErrorDomain                = ErrorDomain(VIR_FROM_AUDIT)
	FROM_AUTH                                                    ErrorDomain                = ErrorDomain(VIR_FROM_AUTH)
	FROM_BHYVE                                                   ErrorDomain                = ErrorDomain(VIR_FROM_BHYVE)
	FROM_BPF                                                     ErrorDomain                = ErrorDomain(VIR_FROM_BPF)
	FROM_CAPABILITIES                                            ErrorDomain                = ErrorDomain(VIR_FROM_CAPABILITIES)
	FROM_CGROUP                                                  ErrorDomain                = ErrorDomain(VIR_FROM_CGROUP)
	FROM_CH                                                      ErrorDomain                = ErrorDomain(VIR_FROM_CH)
	FROM_CONF                                                    ErrorDomain                = ErrorDomain(VIR_FROM_CONF)
	FROM_CPU                                                     ErrorDomain                = ErrorDomain(VIR_FROM_CPU)
	FROM_CRYPTO                                                  ErrorDomain                = ErrorDomain(VIR_FROM_CRYPTO)
	FROM_DBUS                                                    ErrorDomain                = ErrorDomain(VIR_FROM_DBUS)
	FROM_DEVICE                                                  ErrorDomain                = ErrorDomain(VIR_FROM_DEVICE)
	FROM_DOM                                                     ErrorDomain                = ErrorDomain(VIR_FROM_DOM)
	FROM_DOMAIN                                                  ErrorDomain                = ErrorDomain(VIR_FROM_DOMAIN)
	FROM_DOMAIN_CHECKPOINT                                       ErrorDomain                = ErrorDomain(VIR_FROM_DOMAIN_CHECKPOINT)
	FROM_DOMAIN_SNAPSHOT                                         ErrorDomain                = ErrorDomain(VIR_FROM_DOMAIN_SNAPSHOT)
	FROM_ESX                                                     ErrorDomain                = ErrorDomain(VIR_FROM_ESX)
	FROM_EVENT                                                   ErrorDomain                = ErrorDomain(VIR_FROM_EVENT)
	FROM_FIREWALL                                                ErrorDomain                = ErrorDomain(VIR_FROM_FIREWALL)
	FROM_FIREWALLD                                               ErrorDomain                = ErrorDomain(VIR_FROM_FIREWALLD)
	FROM_HOOK                                                    ErrorDomain                = ErrorDomain(VIR_FROM_HOOK)
	FROM_HYPERV                                                  ErrorDomain                = ErrorDomain(VIR_FROM_HYPERV)
	FROM_IDENTITY                                                ErrorDomain                = ErrorDomain(VIR_FROM_IDENTITY)
	FROM_INITCTL                                                 ErrorDomain                = ErrorDomain(VIR_FROM_INITCTL)
	FROM_INTERFACE                                               ErrorDomain                = ErrorDomain(VIR_FROM_INTERFACE)
	FROM_LIBSSH                                                  ErrorDomain                = ErrorDomain(VIR_FROM_LIBSSH)
	FROM_LIBXL                                                   ErrorDomain                = ErrorDomain(VIR_FROM_LIBXL)
	FROM_LOCKING                                                 ErrorDomain                = ErrorDomain(VIR_FROM_LOCKING)
	FROM_LOCKSPACE                                               ErrorDomain                = ErrorDomain(VIR_FROM_LOCKSPACE)
	FROM_LOGGING                                                 ErrorDomain                = ErrorDomain(VIR_FROM_LOGGING)
	FROM_LXC                                                     ErrorDomain                = ErrorDomain(VIR_FROM_LXC)
	FROM_NET                                                     ErrorDomain                = ErrorDomain(VIR_FROM_NET)
	FROM_NETWORK                                                 ErrorDomain                = ErrorDomain(VIR_FROM_NETWORK)
	FROM_NODEDEV                                                 ErrorDomain                = ErrorDomain(VIR_FROM_NODEDEV)
	FROM_NONE                                                    ErrorDomain                = ErrorDomain(VIR_FROM_NONE)
	FROM_NWFILTER                                                ErrorDomain                = ErrorDomain(VIR_FROM_NWFILTER)
	FROM_ONE                                                     ErrorDomain                = ErrorDomain(VIR_FROM_ONE)
	FROM_OPENVZ                                                  ErrorDomain                = ErrorDomain(VIR_FROM_OPENVZ)
	FROM_PARALLELS                                               ErrorDomain                = ErrorDomain(VIR_FROM_PARALLELS)
	FROM_PERF                                                    ErrorDomain                = ErrorDomain(VIR_FROM_PERF)
	FROM_PHYP                                                    ErrorDomain                = ErrorDomain(VIR_FROM_PHYP)
	FROM_POLKIT                                                  ErrorDomain                = ErrorDomain(VIR_FROM_POLKIT)
	FROM_PROXY                                                   ErrorDomain                = ErrorDomain(VIR_FROM_PROXY)
	FROM_QEMU                                                    ErrorDomain                = ErrorDomain(VIR_FROM_QEMU)
	FROM_REMOTE                                                  ErrorDomain                = ErrorDomain(VIR_FROM_REMOTE)
	FROM_RESCTRL                                                 ErrorDomain                = ErrorDomain(VIR_FROM_RESCTRL)
	FROM_RPC                                                     ErrorDomain                = ErrorDomain(VIR_FROM_RPC)
	FROM_SECRET                                                  ErrorDomain                = ErrorDomain(VIR_FROM_SECRET)
	FROM_SECURITY                                                ErrorDomain                = ErrorDomain(VIR_FROM_SECURITY)
	FROM_SEXPR                                                   ErrorDomain                = ErrorDomain(VIR_FROM_SEXPR)
	FROM_SSH                                                     ErrorDomain                = ErrorDomain(VIR_FROM_SSH)
	FROM_STATS_LINUX                                             ErrorDomain                = ErrorDomain(VIR_FROM_STATS_LINUX)
	FROM_STORAGE                                                 ErrorDomain                = ErrorDomain(VIR_FROM_STORAGE)
	FROM_STREAMS                                                 ErrorDomain                = ErrorDomain(VIR_FROM_STREAMS)
	FROM_SYSINFO                                                 ErrorDomain                = ErrorDomain(VIR_FROM_SYSINFO)
	FROM_SYSTEMD                                                 ErrorDomain                = ErrorDomain(VIR_FROM_SYSTEMD)
	FROM_TEST                                                    ErrorDomain                = ErrorDomain(VIR_FROM_TEST)
	FROM_THREAD                                                  ErrorDomain                = ErrorDomain(VIR_FROM_THREAD)
	FROM_TPM                                                     ErrorDomain                = ErrorDomain(VIR_FROM_TPM)
	FROM_UML                                                     ErrorDomain                = ErrorDomain(VIR_FROM_UML)
	FROM_URI                                                     ErrorDomain                = ErrorDomain(VIR_FROM_URI)
	FROM_VBOX                                                    ErrorDomain                = ErrorDomain(VIR_FROM_VBOX)
	FROM_VMWARE                                                  ErrorDomain                = ErrorDomain(VIR_FROM_VMWARE)
	FROM_XEN                                                     ErrorDomain                = ErrorDomain(VIR_FROM_XEN)
	FROM_XENAPI                                                  ErrorDomain                = ErrorDomain(VIR_FROM_XENAPI)
	FROM_XEND                                                    ErrorDomain                = ErrorDomain(VIR_FROM_XEND)
	FROM_XENSTORE                                                ErrorDomain                = ErrorDomain(VIR_FROM_XENSTORE)
	FROM_XENXL                                                   ErrorDomain                = ErrorDomain(VIR_FROM_XENXL)
	FROM_XENXM                                                   ErrorDomain                = ErrorDomain(VIR_FROM_XENXM)
	FROM_XEN_INOTIFY                                             ErrorDomain                = ErrorDomain(VIR_FROM_XEN_INOTIFY)
	FROM_XML                                                     ErrorDomain                = ErrorDomain(VIR_FROM_XML)
	INTERFACE_DEFINE_VALIDATE                                                               = VIR_INTERFACE_DEFINE_VALIDATE
	INTERFACE_XML_INACTIVE                                                                  = VIR_INTERFACE_XML_INACTIVE
	IP_ADDR_TYPE_IPV4                                                                       = VIR_IP_ADDR_TYPE_IPV4
	IP_ADDR_TYPE_IPV6                                                                       = VIR_IP_ADDR_TYPE_IPV6
	IP_ADDR_TYPE_LAST                                                                       = VIR_IP_ADDR_TYPE_LAST
	KEYCODE_SET_ATSET1                                                                      = VIR_KEYCODE_SET_ATSET1
	KEYCODE_SET_ATSET2                                                                      = VIR_KEYCODE_SET_ATSET2
	KEYCODE_SET_ATSET3                                                                      = VIR_KEYCODE_SET_ATSET3
	KEYCODE_SET_LAST                                                                        = VIR_KEYCODE_SET_LAST
	KEYCODE_SET_LINUX                                                                       = VIR_KEYCODE_SET_LINUX
	KEYCODE_SET_OSX                                                                         = VIR_KEYCODE_SET_OSX
	KEYCODE_SET_QNUM                                                                        = VIR_KEYCODE_SET_QNUM
	KEYCODE_SET_USB                                                                         = VIR_KEYCODE_SET_USB
	KEYCODE_SET_WIN32                                                                       = VIR_KEYCODE_SET_WIN32
	KEYCODE_SET_XT                                                                          = VIR_KEYCODE_SET_XT
	KEYCODE_SET_XT_KBD                                                                      = VIR_KEYCODE_SET_XT_KBD
	MEMORY_PHYSICAL                                                                         = VIR_MEMORY_PHYSICAL
	MEMORY_VIRTUAL                                                                          = VIR_MEMORY_VIRTUAL
	MIGRATE_ABORT_ON_ERROR                                                                  = VIR_MIGRATE_ABORT_ON_ERROR
	MIGRATE_AUTO_CONVERGE                                                                   = VIR_MIGRATE_AUTO_CONVERGE
	MIGRATE_CHANGE_PROTECTION                                                               = VIR_MIGRATE_CHANGE_PROTECTION
	MIGRATE_COMPRESSED                                                                      = VIR_MIGRATE_COMPRESSED
	MIGRATE_LIVE                                                                            = VIR_MIGRATE_LIVE
	MIGRATE_NON_SHARED_DISK                                                                 = VIR_MIGRATE_NON_SHARED_DISK
	MIGRATE_NON_SHARED_INC                                                                  = VIR_MIGRATE_NON_SHARED_INC
	MIGRATE_NON_SHARED_SYNCHRONOUS_WRITES                                                   = VIR_MIGRATE_NON_SHARED_SYNCHRONOUS_WRITES
	MIGRATE_OFFLINE                                                                         = VIR_MIGRATE_OFFLINE
	MIGRATE_PARALLEL                                                                        = VIR_MIGRATE_PARALLEL
	MIGRATE_PAUSED                                                                          = VIR_MIGRATE_PAUSED
	MIGRATE_PEER2PEER                                                                       = VIR_MIGRATE_PEER2PEER
	MIGRATE_PERSIST_DEST                                                                    = VIR_MIGRATE_PERSIST_DEST
	MIGRATE_POSTCOPY                                                                        = VIR_MIGRATE_POSTCOPY
	MIGRATE_POSTCOPY_RESUME                                                                 = VIR_MIGRATE_POSTCOPY_RESUME
	MIGRATE_RDMA_PIN_ALL                                                                    = VIR_MIGRATE_RDMA_PIN_ALL
	MIGRATE_TLS                                                                             = VIR_MIGRATE_TLS
	MIGRATE_TUNNELLED                                                                       = VIR_MIGRATE_TUNNELLED
	MIGRATE_UNDEFINE_SOURCE                                                                 = VIR_MIGRATE_UNDEFINE_SOURCE
	MIGRATE_UNSAFE                                                                          = VIR_MIGRATE_UNSAFE
	MIGRATE_ZEROCOPY                                                                        = VIR_MIGRATE_ZEROCOPY
	NETWORK_CREATE_VALIDATE                                                                 = VIR_NETWORK_CREATE_VALIDATE
	NETWORK_DEFINE_VALIDATE                                                                 = VIR_NETWORK_DEFINE_VALIDATE
	NETWORK_EVENT_DEFINED                                                                   = VIR_NETWORK_EVENT_DEFINED
	NETWORK_EVENT_ID_LAST                                                                   = VIR_NETWORK_EVENT_ID_LAST
	NETWORK_EVENT_ID_LIFECYCLE                                                              = VIR_NETWORK_EVENT_ID_LIFECYCLE
	NETWORK_EVENT_ID_METADATA_CHANGE                                                        = VIR_NETWORK_EVENT_ID_METADATA_CHANGE
	NETWORK_EVENT_LAST                                                                      = VIR_NETWORK_EVENT_LAST
	NETWORK_EVENT_STARTED                                                                   = VIR_NETWORK_EVENT_STARTED
	NETWORK_EVENT_STOPPED                                                                   = VIR_NETWORK_EVENT_STOPPED
	NETWORK_EVENT_UNDEFINED                                                                 = VIR_NETWORK_EVENT_UNDEFINED
	NETWORK_METADATA_DESCRIPTION                                                            = VIR_NETWORK_METADATA_DESCRIPTION
	NETWORK_METADATA_ELEMENT                                                                = VIR_NETWORK_METADATA_ELEMENT
	NETWORK_METADATA_LAST                                                                   = VIR_NETWORK_METADATA_LAST
	NETWORK_METADATA_TITLE                                                                  = VIR_NETWORK_METADATA_TITLE
	NETWORK_PORT_CREATE_RECLAIM                                                             = VIR_NETWORK_PORT_CREATE_RECLAIM
	NETWORK_PORT_CREATE_VALIDATE                                                            = VIR_NETWORK_PORT_CREATE_VALIDATE
	NETWORK_SECTION_BRIDGE                                                                  = VIR_NETWORK_SECTION_BRIDGE
	NETWORK_SECTION_DNS_HOST                                                                = VIR_NETWORK_SECTION_DNS_HOST
	NETWORK_SECTION_DNS_SRV                                                                 = VIR_NETWORK_SECTION_DNS_SRV
	NETWORK_SECTION_DNS_TXT                                                                 = VIR_NETWORK_SECTION_DNS_TXT
	NETWORK_SECTION_DOMAIN                                                                  = VIR_NETWORK_SECTION_DOMAIN
	NETWORK_SECTION_FORWARD                                                                 = VIR_NETWORK_SECTION_FORWARD
	NETWORK_SECTION_FORWARD_INTERFACE                                                       = VIR_NETWORK_SECTION_FORWARD_INTERFACE
	NETWORK_SECTION_FORWARD_PF                                                              = VIR_NETWORK_SECTION_FORWARD_PF
	NETWORK_SECTION_IP                                                                      = VIR_NETWORK_SECTION_IP
	NETWORK_SECTION_IP_DHCP_HOST                                                            = VIR_NETWORK_SECTION_IP_DHCP_HOST
	NETWORK_SECTION_IP_DHCP_RANGE                                                           = VIR_NETWORK_SECTION_IP_DHCP_RANGE
	NETWORK_SECTION_LAST                                                                    = VIR_NETWORK_SECTION_LAST
	NETWORK_SECTION_NONE                                                                    = VIR_NETWORK_SECTION_NONE
	NETWORK_SECTION_PORTGROUP                                                               = VIR_NETWORK_SECTION_PORTGROUP
	NETWORK_UPDATE_AFFECT_CONFIG                                                            = VIR_NETWORK_UPDATE_AFFECT_CONFIG
	NETWORK_UPDATE_AFFECT_CURRENT                                                           = VIR_NETWORK_UPDATE_AFFECT_CURRENT
	NETWORK_UPDATE_AFFECT_LIVE                                                              = VIR_NETWORK_UPDATE_AFFECT_LIVE
	NETWORK_UPDATE_COMMAND_ADD_FIRST                                                        = VIR_NETWORK_UPDATE_COMMAND_ADD_FIRST
	NETWORK_UPDATE_COMMAND_ADD_LAST                                                         = VIR_NETWORK_UPDATE_COMMAND_ADD_LAST
	NETWORK_UPDATE_COMMAND_DELETE                                                           = VIR_NETWORK_UPDATE_COMMAND_DELETE
	NETWORK_UPDATE_COMMAND_LAST                                                             = VIR_NETWORK_UPDATE_COMMAND_LAST
	NETWORK_UPDATE_COMMAND_MODIFY                                                           = VIR_NETWORK_UPDATE_COMMAND_MODIFY
	NETWORK_UPDATE_COMMAND_NONE                                                             = VIR_NETWORK_UPDATE_COMMAND_NONE
	NETWORK_XML_INACTIVE                                                                    = VIR_NETWORK_XML_INACTIVE
	NODE_ALLOC_PAGES_ADD                                                                    = VIR_NODE_ALLOC_PAGES_ADD
	NODE_ALLOC_PAGES_SET                                                                    = VIR_NODE_ALLOC_PAGES_SET
	NODE_CPU_STATS_ALL_CPUS                                                                 = VIR_NODE_CPU_STATS_ALL_CPUS
	NODE_DEVICE_CREATE_XML_VALIDATE                                                         = VIR_NODE_DEVICE_CREATE_XML_VALIDATE
	NODE_DEVICE_DEFINE_XML_VALIDATE                                                         = VIR_NODE_DEVICE_DEFINE_XML_VALIDATE
	NODE_DEVICE_EVENT_CREATED                                                               = VIR_NODE_DEVICE_EVENT_CREATED
	NODE_DEVICE_EVENT_DEFINED                                                               = VIR_NODE_DEVICE_EVENT_DEFINED
	NODE_DEVICE_EVENT_DELETED                                                               = VIR_NODE_DEVICE_EVENT_DELETED
	NODE_DEVICE_EVENT_ID_LAST                                                               = VIR_NODE_DEVICE_EVENT_ID_LAST
	NODE_DEVICE_EVENT_ID_LIFECYCLE                                                          = VIR_NODE_DEVICE_EVENT_ID_LIFECYCLE
	NODE_DEVICE_EVENT_ID_UPDATE                                                             = VIR_NODE_DEVICE_EVENT_ID_UPDATE
	NODE_DEVICE_EVENT_LAST                                                                  = VIR_NODE_DEVICE_EVENT_LAST
	NODE_DEVICE_EVENT_UNDEFINED                                                             = VIR_NODE_DEVICE_EVENT_UNDEFINED
	NODE_DEVICE_UPDATE_AFFECT_CONFIG                                                        = VIR_NODE_DEVICE_UPDATE_AFFECT_CONFIG
	NODE_DEVICE_UPDATE_AFFECT_CURRENT                                                       = VIR_NODE_DEVICE_UPDATE_AFFECT_CURRENT
	NODE_DEVICE_UPDATE_AFFECT_LIVE                                                          = VIR_NODE_DEVICE_UPDATE_AFFECT_LIVE
	NODE_DEVICE_XML_INACTIVE                                                                = VIR_NODE_DEVICE_XML_INACTIVE
	NODE_MEMORY_STATS_ALL_CELLS                                                             = VIR_NODE_MEMORY_STATS_ALL_CELLS
	NODE_SUSPEND_TARGET_DISK                                                                = VIR_NODE_SUSPEND_TARGET_DISK
	NODE_SUSPEND_TARGET_HYBRID                                                              = VIR_NODE_SUSPEND_TARGET_HYBRID
	NODE_SUSPEND_TARGET_LAST                                                                = VIR_NODE_SUSPEND_TARGET_LAST
	NODE_SUSPEND_TARGET_MEM                                                                 = VIR_NODE_SUSPEND_TARGET_MEM
	NWFILTER_BINDING_CREATE_VALIDATE                                                        = VIR_NWFILTER_BINDING_CREATE_VALIDATE
	NWFILTER_DEFINE_VALIDATE                                                                = VIR_NWFILTER_DEFINE_VALIDATE
	SECRET_DEFINE_VALIDATE                                                                  = VIR_SECRET_DEFINE_VALIDATE
	SECRET_EVENT_DEFINED                                                                    = VIR_SECRET_EVENT_DEFINED
	SECRET_EVENT_ID_LAST                                                                    = VIR_SECRET_EVENT_ID_LAST
	SECRET_EVENT_ID_LIFECYCLE                                                               = VIR_SECRET_EVENT_ID_LIFECYCLE
	SECRET_EVENT_ID_VALUE_CHANGED                                                           = VIR_SECRET_EVENT_ID_VALUE_CHANGED
	SECRET_EVENT_LAST                                                                       = VIR_SECRET_EVENT_LAST
	SECRET_EVENT_UNDEFINED                                                                  = VIR_SECRET_EVENT_UNDEFINED
	SECRET_USAGE_TYPE_CEPH                                                                  = VIR_SECRET_USAGE_TYPE_CEPH
	SECRET_USAGE_TYPE_ISCSI                                                                 = VIR_SECRET_USAGE_TYPE_ISCSI
	SECRET_USAGE_TYPE_LAST                                                                  = VIR_SECRET_USAGE_TYPE_LAST
	SECRET_USAGE_TYPE_NONE                                                                  = VIR_SECRET_USAGE_TYPE_NONE
	SECRET_USAGE_TYPE_TLS                                                                   = VIR_SECRET_USAGE_TYPE_TLS
	SECRET_USAGE_TYPE_VOLUME                                                                = VIR_SECRET_USAGE_TYPE_VOLUME
	SECRET_USAGE_TYPE_VTPM                                                                  = VIR_SECRET_USAGE_TYPE_VTPM
	STORAGE_POOL_BUILDING                                                                   = VIR_STORAGE_POOL_BUILDING
	STORAGE_POOL_BUILD_NEW                                                                  = VIR_STORAGE_POOL_BUILD_NEW
	STORAGE_POOL_BUILD_NO_OVERWRITE                                                         = VIR_STORAGE_POOL_BUILD_NO_OVERWRITE
	STORAGE_POOL_BUILD_OVERWRITE                                                            = VIR_STORAGE_POOL_BUILD_OVERWRITE
	STORAGE_POOL_BUILD_REPAIR                                                               = VIR_STORAGE_POOL_BUILD_REPAIR
	STORAGE_POOL_BUILD_RESIZE                                                               = VIR_STORAGE_POOL_BUILD_RESIZE
	STORAGE_POOL_CREATE_NORMAL                                                              = VIR_STORAGE_POOL_CREATE_NORMAL
	STORAGE_POOL_CREATE_WITH_BUILD                                                          = VIR_STORAGE_POOL_CREATE_WITH_BUILD
	STORAGE_POOL_CREATE_WITH_BUILD_NO_OVERWRITE                                             = VIR_STORAGE_POOL_CREATE_WITH_BUILD_NO_OVERWRITE
	STORAGE_POOL_CREATE_WITH_BUILD_OVERWRITE                                                = VIR_STORAGE_POOL_CREATE_WITH_BUILD_OVERWRITE
	STORAGE_POOL_DEFINE_VALIDATE                                                            = VIR_STORAGE_POOL_DEFINE_VALIDATE
	STORAGE_POOL_DEGRADED                                                                   = VIR_STORAGE_POOL_DEGRADED
	STORAGE_POOL_DELETE_NORMAL                                                              = VIR_STORAGE_POOL_DELETE_NORMAL
	STORAGE_POOL_DELETE_ZEROED                                                              = VIR_STORAGE_POOL_DELETE_ZEROED
	STORAGE_POOL_EVENT_CREATED                                                              = VIR_STORAGE_POOL_EVENT_CREATED
	STORAGE_POOL_EVENT_DEFINED                                                              = VIR_STORAGE_POOL_EVENT_DEFINED
	STORAGE_POOL_EVENT_DELETED                                                              = VIR_STORAGE_POOL_EVENT_DELETED
	STORAGE_POOL_EVENT_ID_LAST                                                              = VIR_STORAGE_POOL_EVENT_ID_LAST
	STORAGE_POOL_EVENT_ID_LIFECYCLE                                                         = VIR_STORAGE_POOL_EVENT_ID_LIFECYCLE
	STORAGE_POOL_EVENT_ID_REFRESH                                                           = VIR_STORAGE_POOL_EVENT_ID_REFRESH
	STORAGE_POOL_EVENT_LAST                                                                 = VIR_STORAGE_POOL_EVENT_LAST
	STORAGE_POOL_EVENT_STARTED                                                              = VIR_STORAGE_POOL_EVENT_STARTED
	STORAGE_POOL_EVENT_STOPPED                                                              = VIR_STORAGE_POOL_EVENT_STOPPED
	STORAGE_POOL_EVENT_UNDEFINED                                                            = VIR_STORAGE_POOL_EVENT_UNDEFINED
	STORAGE_POOL_INACCESSIBLE                                                               = VIR_STORAGE_POOL_INACCESSIBLE
	STORAGE_POOL_INACTIVE                                                                   = VIR_STORAGE_POOL_INACTIVE
	STORAGE_POOL_RUNNING                                                                    = VIR_STORAGE_POOL_RUNNING
	STORAGE_POOL_STATE_LAST                                                                 = VIR_STORAGE_POOL_STATE_LAST
	STORAGE_VOL_BLOCK                                                                       = VIR_STORAGE_VOL_BLOCK
	STORAGE_VOL_CREATE_PREALLOC_METADATA                                                    = VIR_STORAGE_VOL_CREATE_PREALLOC_METADATA
	STORAGE_VOL_CREATE_REFLINK                                                              = VIR_STORAGE_VOL_CREATE_REFLINK
	STORAGE_VOL_CREATE_VALIDATE                                                             = VIR_STORAGE_VOL_CREATE_VALIDATE
	STORAGE_VOL_DELETE_NORMAL                                                               = VIR_STORAGE_VOL_DELETE_NORMAL
	STORAGE_VOL_DELETE_WITH_SNAPSHOTS                                                       = VIR_STORAGE_VOL_DELETE_WITH_SNAPSHOTS
	STORAGE_VOL_DELETE_ZEROED                                                               = VIR_STORAGE_VOL_DELETE_ZEROED
	STORAGE_VOL_DIR                                                                         = VIR_STORAGE_VOL_DIR
	STORAGE_VOL_DOWNLOAD_SPARSE_STREAM                                                      = VIR_STORAGE_VOL_DOWNLOAD_SPARSE_STREAM
	STORAGE_VOL_FILE                                                                        = VIR_STORAGE_VOL_FILE
	STORAGE_VOL_GET_PHYSICAL                                                                = VIR_STORAGE_VOL_GET_PHYSICAL
	STORAGE_VOL_LAST                                                                        = VIR_STORAGE_VOL_LAST
	STORAGE_VOL_NETDIR                                                                      = VIR_STORAGE_VOL_NETDIR
	STORAGE_VOL_NETWORK                                                                     = VIR_STORAGE_VOL_NETWORK
	STORAGE_VOL_PLOOP                                                                       = VIR_STORAGE_VOL_PLOOP
	STORAGE_VOL_RESIZE_ALLOCATE                                                             = VIR_STORAGE_VOL_RESIZE_ALLOCATE
	STORAGE_VOL_RESIZE_DELTA                                                                = VIR_STORAGE_VOL_RESIZE_DELTA
	STORAGE_VOL_RESIZE_SHRINK                                                               = VIR_STORAGE_VOL_RESIZE_SHRINK
	STORAGE_VOL_UPLOAD_SPARSE_STREAM                                                        = VIR_STORAGE_VOL_UPLOAD_SPARSE_STREAM
	STORAGE_VOL_USE_ALLOCATION                                                              = VIR_STORAGE_VOL_USE_ALLOCATION
	STORAGE_VOL_WIPE_ALG_BSI                                                                = VIR_STORAGE_VOL_WIPE_ALG_BSI
	STORAGE_VOL_WIPE_ALG_DOD                                                                = VIR_STORAGE_VOL_WIPE_ALG_DOD
	STORAGE_VOL_WIPE_ALG_GUTMANN                                                            = VIR_STORAGE_VOL_WIPE_ALG_GUTMANN
	STORAGE_VOL_WIPE_ALG_LAST                                                               = VIR_STORAGE_VOL_WIPE_ALG_LAST
	STORAGE_VOL_WIPE_ALG_NNSA                                                               = VIR_STORAGE_VOL_WIPE_ALG_NNSA
	STORAGE_VOL_WIPE_ALG_PFITZNER33                                                         = VIR_STORAGE_VOL_WIPE_ALG_PFITZNER33
	STORAGE_VOL_WIPE_ALG_PFITZNER7                                                          = VIR_STORAGE_VOL_WIPE_ALG_PFITZNER7
	STORAGE_VOL_WIPE_ALG_RANDOM                                                             = VIR_STORAGE_VOL_WIPE_ALG_RANDOM
	STORAGE_VOL_WIPE_ALG_SCHNEIER                                                           = VIR_STORAGE_VOL_WIPE_ALG_SCHNEIER
	STORAGE_VOL_WIPE_ALG_TRIM                                                               = VIR_STORAGE_VOL_WIPE_ALG_TRIM
	STORAGE_VOL_WIPE_ALG_ZERO                                                               = VIR_STORAGE_VOL_WIPE_ALG_ZERO
	STORAGE_XML_INACTIVE                                                                    = VIR_STORAGE_XML_INACTIVE
	STREAM_EVENT_ERROR                                                                      = VIR_STREAM_EVENT_ERROR
	STREAM_EVENT_HANGUP                                                                     = VIR_STREAM_EVENT_HANGUP
	STREAM_EVENT_READABLE                                                                   = VIR_STREAM_EVENT_READABLE
	STREAM_EVENT_WRITABLE                                                                   = VIR_STREAM_EVENT_WRITABLE
	STREAM_NONBLOCK                                                                         = VIR_STREAM_NONBLOCK
	STREAM_RECV_STOP_AT_HOLE                                                                = VIR_STREAM_RECV_STOP_AT_HOLE
	TYPED_PARAM_BOOLEAN                                                                     = VIR_TYPED_PARAM_BOOLEAN
	TYPED_PARAM_DOUBLE                                                                      = VIR_TYPED_PARAM_DOUBLE
	TYPED_PARAM_INT                                                                         = VIR_TYPED_PARAM_INT
	TYPED_PARAM_LAST                                                                        = VIR_TYPED_PARAM_LAST
	TYPED_PARAM_LLONG                                                                       = VIR_TYPED_PARAM_LLONG
	TYPED_PARAM_STRING                                                                      = VIR_TYPED_PARAM_STRING
	TYPED_PARAM_STRING_OKAY                                                                 = VIR_TYPED_PARAM_STRING_OKAY
	TYPED_PARAM_UINT                                                                        = VIR_TYPED_PARAM_UINT
	TYPED_PARAM_ULLONG                                                                      = VIR_TYPED_PARAM_ULLONG
	VCPU_BLOCKED                                                                            = VIR_VCPU_BLOCKED
	VCPU_INFO_CPU_OFFLINE                                                                   = VIR_VCPU_INFO_CPU_OFFLINE
	VCPU_INFO_CPU_UNAVAILABLE                                                               = VIR_VCPU_INFO_CPU_UNAVAILABLE
	VCPU_LAST                                                                               = VIR_VCPU_LAST
	VCPU_OFFLINE                                                                            = VIR_VCPU_OFFLINE
	VCPU_RUNNING                                                                            = VIR_VCPU_RUNNING
	WAR_NO_INTERFACE                                             ErrorNumber                = ErrorNumber(VIR_WAR_NO_INTERFACE)
	WAR_NO_NETWORK                                               ErrorNumber                = ErrorNumber(VIR_WAR_NO_NETWORK)
	WAR_NO_NODE                                                  ErrorNumber                = ErrorNumber(VIR_WAR_NO_NODE)
	WAR_NO_NWFILTER                                              ErrorNumber                = ErrorNumber(VIR_WAR_NO_NWFILTER)
	WAR_NO_SECRET                                                ErrorNumber                = ErrorNumber(VIR_WAR_NO_SECRET)
	WAR_NO_STORAGE                                               ErrorNumber                = ErrorNumber(VIR_WAR_NO_STORAGE)
)
